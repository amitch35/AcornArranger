(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function e(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=e(s);fetch(s.href,r)}})();var gs;let Rt=class extends Error{};Rt.prototype.name="InvalidTokenError";function Ni(n){return decodeURIComponent(atob(n).replace(/(.)/g,(t,e)=>{let i=e.charCodeAt(0).toString(16).toUpperCase();return i.length<2&&(i="0"+i),"%"+i}))}function Li(n){let t=n.replace(/-/g,"+").replace(/_/g,"/");switch(t.length%4){case 0:break;case 2:t+="==";break;case 3:t+="=";break;default:throw new Error("base64 string is not of the correct length")}try{return Ni(t)}catch{return atob(t)}}function Bs(n,t){if(typeof n!="string")throw new Rt("Invalid token specified: must be a string");t||(t={});const e=t.header===!0?0:1,i=n.split(".")[e];if(typeof i!="string")throw new Rt(`Invalid token specified: missing part #${e+1}`);let s;try{s=Li(i)}catch(r){throw new Rt(`Invalid token specified: invalid base64 for part #${e+1} (${r.message})`)}try{return JSON.parse(s)}catch(r){throw new Rt(`Invalid token specified: invalid json for part #${e+1} (${r.message})`)}}const Di="mu:context",ze=`${Di}:change`;class Hi{constructor(t,e){this._proxy=qi(t,e)}get value(){return this._proxy}set value(t){Object.assign(this._proxy,t)}apply(t){this.value=t(this.value)}}class je extends HTMLElement{constructor(t){super(),console.log("Constructing context provider",this),this.context=new Hi(t,this),this.style.display="contents"}attach(t){return this.addEventListener(ze,t),t}detach(t){this.removeEventListener(ze,t)}}function qi(n,t){return new Proxy(n,{get:(i,s,r)=>{if(s==="then")return;const a=Reflect.get(i,s,r);return console.log(`Context['${s}'] => `,a),a},set:(i,s,r,a)=>{const o=n[s];console.log(`Context['${s.toString()}'] <= `,r);const l=Reflect.set(i,s,r,a);if(l){let f=new CustomEvent(ze,{bubbles:!0,cancelable:!0,composed:!0});Object.assign(f,{property:s,oldValue:o,value:r}),t.dispatchEvent(f)}else console.log(`Context['${s}] was not set to ${r}`);return l}})}function Fi(n,t){const e=Ws(t,n);return new Promise((i,s)=>{if(e){const r=e.localName;customElements.whenDefined(r).then(()=>i(e))}else s({context:t,reason:`No provider for this context "${t}:`})})}function Ws(n,t){const e=`[provides="${n}"]`;if(!t||t===document.getRootNode())return;const i=t.closest(e);if(i)return i;const s=t.getRootNode();if(s instanceof ShadowRoot)return Ws(n,s.host)}class Xi extends CustomEvent{constructor(t,e="mu:message"){super(e,{bubbles:!0,composed:!0,detail:t})}}function Js(n="mu:message"){return(t,...e)=>t.dispatchEvent(new Xi(e,n))}class Ne{constructor(t,e,i="service:message",s=!0){this._pending=[],this._context=e,this._update=t,this._eventType=i,this._running=s}attach(t){t.addEventListener(this._eventType,e=>{e.stopPropagation();const i=e.detail;this.consume(i)})}start(){this._running||(console.log(`Starting ${this._eventType} service`),this._running=!0,this._pending.forEach(t=>this.process(t)))}apply(t){this._context.apply(t)}consume(t){this._running?this.process(t):(console.log(`Queueing ${this._eventType} message`,t),this._pending.push(t))}process(t){console.log(`Processing ${this._eventType} message`,t);const e=this._update(t,this.apply.bind(this));e&&e(this._context.value)}}function Yi(n){return t=>({...t,...n})}const Oe="mu:auth:jwt",Vs=class Gs extends Ne{constructor(t,e){super((i,s)=>this.update(i,s),t,Gs.EVENT_TYPE),this._redirectForLogin=e}update(t,e){switch(t[0]){case"auth/signin":const{token:i,redirect:s}=t[1];return e(Wi(i)),we(s);case"auth/signout":return e(Ji()),we(this._redirectForLogin);case"auth/redirect":return we(this._redirectForLogin,{next:window.location.href});default:const r=t[0];throw new Error(`Unhandled Auth message "${r}"`)}}};Vs.EVENT_TYPE="auth:message";let Zs=Vs;const Ks=Js(Zs.EVENT_TYPE);function we(n,t={}){if(!n)return;const e=window.location.href,i=new URL(n,e);return Object.entries(t).forEach(([s,r])=>i.searchParams.set(s,r)),()=>{console.log("Redirecting to ",n),window.location.assign(i)}}class Bi extends je{get redirect(){return this.getAttribute("redirect")||void 0}constructor(){super({user:mt.authenticateFromLocalStorage()})}connectedCallback(){new Zs(this.context,this.redirect).attach(this)}}class ft{constructor(){this.authenticated=!1,this.username="anonymous"}static deauthenticate(t){return t.authenticated=!1,t.username="anonymous",localStorage.removeItem(Oe),t}}class mt extends ft{constructor(t){super();const e=Bs(t);console.log("Token payload",e),this.token=t,this.authenticated=!0,this.username=e.username}static authenticate(t){const e=new mt(t);return localStorage.setItem(Oe,t),e}static authenticateFromLocalStorage(){const t=localStorage.getItem(Oe);return t?mt.authenticate(t):new ft}}function Wi(n){return Yi({user:mt.authenticate(n),token:n})}function Ji(){return n=>{const t=n.user;return{user:t&&t.authenticated?ft.deauthenticate(t):t,token:""}}}function Vi(n){return n.authenticated?{Authorization:`Bearer ${n.token||"NO_TOKEN"}`}:{}}function Gi(n){return n.authenticated?Bs(n.token||""):{}}const E=Object.freeze(Object.defineProperty({__proto__:null,AuthenticatedUser:mt,Provider:Bi,User:ft,dispatch:Ks,headers:Vi,payload:Gi},Symbol.toStringTag,{value:"Module"}));function ne(n,t,e){const i=n.target,s=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});console.log(`Relaying event from ${n.type}:`,s),i.dispatchEvent(s),n.stopPropagation()}function Te(n,t="*"){return n.composedPath().find(i=>{const s=i;return s.tagName&&s.matches(t)})}const Jt=Object.freeze(Object.defineProperty({__proto__:null,originalTarget:Te,relay:ne},Symbol.toStringTag,{value:"Module"})),Zi=new DOMParser;function Vt(n,...t){const e=n.map((a,o)=>o?[t[o-1],a]:[a]).flat().join(""),i=Zi.parseFromString(e,"text/html"),s=i.head.childElementCount?i.head.children:i.body.children,r=new DocumentFragment;return r.replaceChildren(...s),r}function ge(n){const t=n.firstElementChild,e=t&&t.tagName==="TEMPLATE"?t:void 0;return{attach:i};function i(s,r={mode:"open"}){const a=s.attachShadow(r);return e&&a.appendChild(e.content.cloneNode(!0)),a}}const Qs=class ti extends HTMLElement{constructor(){super(),this._state={},ge(ti.template).attach(this),this.addEventListener("change",t=>{const e=t.target;if(e){const i=e.name,s=e.value;i&&(this._state[i]=s)}}),this.form&&this.form.addEventListener("submit",t=>{t.preventDefault(),ne(t,"mu-form:submit",this._state)})}set init(t){this._state=t||{},Qi(this._state,this)}get form(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("form")}};Qs.template=Vt`
  ...
  `;let Ki=Qs;function Qi(n,t){const e=Object.entries(n);for(const[i,s]of e){const r=t.querySelector(`[name="${i}"]`);if(r){const a=r;switch(a.type){case"checkbox":const o=a;o.checked=!!s;break;case"date":a.value=s.toISOString().substr(0,10);break;default:a.value=s;break}}}return n}const tn=Object.freeze(Object.defineProperty({__proto__:null,Element:Ki},Symbol.toStringTag,{value:"Module"})),ei=class si extends Ne{constructor(t){super((e,i)=>this.update(e,i),t,si.EVENT_TYPE)}update(t,e){switch(t[0]){case"history/navigate":{const{href:i,state:s}=t[1];e(sn(i,s));break}case"history/redirect":{const{href:i,state:s}=t[1];e(nn(i,s));break}}}};ei.EVENT_TYPE="history:message";let Le=ei;class vs extends je{constructor(){super({location:document.location,state:{}}),this.addEventListener("click",t=>{const e=en(t);if(e){const i=new URL(e.href);i.origin===this.context.value.location.origin&&(console.log("Preventing Click Event on <A>",t),t.preventDefault(),De(e,"history/navigate",{href:i.pathname+i.search}))}}),window.addEventListener("popstate",t=>{console.log("Popstate",t.state),this.context.value={location:document.location,state:t.state}})}connectedCallback(){new Le(this.context).attach(this)}}function en(n){const t=n.currentTarget,e=i=>i.tagName=="A"&&i.href;if(n.button===0)if(n.composed){const s=n.composedPath().find(e);return s||void 0}else{for(let i=n.target;i;i===t?null:i.parentElement)if(e(i))return i;return}}function sn(n,t={}){return history.pushState(t,"",n),()=>({location:document.location,state:history.state})}function nn(n,t={}){return history.replaceState(t,"",n),()=>({location:document.location,state:history.state})}const De=Js(Le.EVENT_TYPE),ii=Object.freeze(Object.defineProperty({__proto__:null,HistoryProvider:vs,Provider:vs,Service:Le,dispatch:De},Symbol.toStringTag,{value:"Module"}));class et{constructor(t,e){this._effects=[],this._target=t,this._contextLabel=e}observe(t=void 0){return new Promise((e,i)=>{if(this._provider){const s=new bs(this._provider,t);this._effects.push(s),e(s)}else Fi(this._target,this._contextLabel).then(s=>{const r=new bs(s,t);this._provider=s,this._effects.push(r),s.attach(a=>this._handleChange(a)),e(r)}).catch(s=>console.log(`Observer ${this._contextLabel} failed to locate a provider`,s))})}_handleChange(t){console.log("Received change event for observers",t,this._effects),this._effects.forEach(e=>e.runEffect())}}class bs{constructor(t,e){this._provider=t,e&&this.setEffect(e)}get context(){return this._provider.context}get value(){return this.context.value}setEffect(t){this._effectFn=t,this.runEffect()}runEffect(){this._effectFn&&this._effectFn(this.context.value)}}const He=class ni extends HTMLElement{constructor(){super(),this._state={},this._user=new ft,this._authObserver=new et(this,"blazing:auth"),ge(ni.template).attach(this),this.form&&this.form.addEventListener("submit",t=>{if(t.preventDefault(),this.src||this.action){if(console.log("Submitting form",this._state),this.action)this.action(this._state);else if(this.src){const e=this.isNew?"POST":"PUT",i=this.isNew?"created":"updated",s=this.isNew?this.src.replace(/[/][$]new$/,""):this.src;an(s,this._state,e,this.authorization).then(r=>Ct(r,this)).then(r=>{const a=`mu-rest-form:${i}`,o=new CustomEvent(a,{bubbles:!0,composed:!0,detail:{method:e,[i]:r,url:s}});this.dispatchEvent(o)}).catch(r=>{const a="mu-rest-form:error",o=new CustomEvent(a,{bubbles:!0,composed:!0,detail:{method:e,error:r,url:s,request:this._state}});this.dispatchEvent(o)})}}}),this.addEventListener("change",t=>{const e=t.target;if(e){const i=e.name,s=e.value;i&&(this._state[i]=s)}})}get src(){return this.getAttribute("src")}get isNew(){return this.hasAttribute("new")}set init(t){this._state=t||{},Ct(this._state,this)}get form(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("form")}get authorization(){var t;return(t=this._user)!=null&&t.authenticated?{Authorization:`Bearer ${this._user.token}`}:{}}connectedCallback(){this._authObserver.observe(({user:t})=>{t&&(this._user=t,this.src&&!this.isNew&&Re(this.src,this.authorization).then(e=>{this._state=e,Ct(e,this)}))})}attributeChangedCallback(t,e,i){switch(t){case"src":this.src&&i&&i!==e&&!this.isNew&&Re(this.src,this.authorization).then(s=>{this._state=s,Ct(s,this)});break;case"new":i&&(this._state={},Ct({},this));break}}};He.observedAttributes=["src","new","action"];He.template=Vt`
    <template>
      <form autocomplete="off">
        <slot></slot>
        <slot name="submit">
  ...
  `;let rn=He;function Re(n,t){return fetch(n,{headers:t}).then(e=>{if(e.status!==200)throw`Status: ${e.status}`;return e.json()}).catch(e=>console.log(`Failed to load form from ${n}:`,e))}function Ct(n,t){const e=Object.entries(n);for(const[i,s]of e){const r=t.querySelector(`[name="${i}"]`);if(r){const a=r;switch(a.type){case"checkbox":const o=a;o.checked=!!s;break;default:a.value=s;break}}}return n}function an(n,t,e="PUT",i={}){return fetch(n,{method:e,headers:{"Content-Type":"application/json",...i},body:JSON.stringify(t)}).then(s=>{if(s.status!=200&&s.status!=201)throw`Form submission failed: Status ${s.status}`;return s.json()})}const qe=Object.freeze(Object.defineProperty({__proto__:null,FormElement:rn,fetchData:Re},Symbol.toStringTag,{value:"Module"})),ri=class ai extends Ne{constructor(t,e){super(e,t,ai.EVENT_TYPE,!1)}};ri.EVENT_TYPE="mu:message";let oi=ri;class on extends je{constructor(t,e,i){super(e),this._user=new ft,this._updateFn=t,this._authObserver=new et(this,i)}connectedCallback(){const t=new oi(this.context,(e,i)=>this._updateFn(e,i,this._user));t.attach(this),this._authObserver.observe(({user:e})=>{console.log("Store got auth",e),e&&(this._user=e),t.start()})}}const ln=Object.freeze(Object.defineProperty({__proto__:null,Provider:on,Service:oi},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const se=globalThis,Fe=se.ShadowRoot&&(se.ShadyCSS===void 0||se.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Xe=Symbol(),_s=new WeakMap;let li=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==Xe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(Fe&&t===void 0){const i=e!==void 0&&e.length===1;i&&(t=_s.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&_s.set(e,t))}return t}toString(){return this.cssText}};const cn=n=>new li(typeof n=="string"?n:n+"",void 0,Xe),dn=(n,...t)=>{const e=n.length===1?n[0]:t.reduce((i,s,r)=>i+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+n[r+1],n[0]);return new li(e,n,Xe)},hn=(n,t)=>{if(Fe)n.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of t){const i=document.createElement("style"),s=se.litNonce;s!==void 0&&i.setAttribute("nonce",s),i.textContent=e.cssText,n.appendChild(i)}},ys=Fe?n=>n:n=>n instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return cn(e)})(n):n;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:pn,defineProperty:un,getOwnPropertyDescriptor:fn,getOwnPropertyNames:mn,getOwnPropertySymbols:gn,getPrototypeOf:vn}=Object,gt=globalThis,$s=gt.trustedTypes,bn=$s?$s.emptyScript:"",xs=gt.reactiveElementPolyfillSupport,Mt=(n,t)=>n,re={toAttribute(n,t){switch(t){case Boolean:n=n?bn:null;break;case Object:case Array:n=n==null?n:JSON.stringify(n)}return n},fromAttribute(n,t){let e=n;switch(t){case Boolean:e=n!==null;break;case Number:e=n===null?null:Number(n);break;case Object:case Array:try{e=JSON.parse(n)}catch{e=null}}return e}},Ye=(n,t)=>!pn(n,t),ws={attribute:!0,type:String,converter:re,reflect:!1,hasChanged:Ye};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),gt.litPropertyMetadata??(gt.litPropertyMetadata=new WeakMap);let ht=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=ws){if(e.state&&(e.attribute=!1),this._$Ei(),this.elementProperties.set(t,e),!e.noAccessor){const i=Symbol(),s=this.getPropertyDescriptor(t,i,e);s!==void 0&&un(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){const{get:s,set:r}=fn(this.prototype,t)??{get(){return this[e]},set(a){this[e]=a}};return{get(){return s==null?void 0:s.call(this)},set(a){const o=s==null?void 0:s.call(this);r.call(this,a),this.requestUpdate(t,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??ws}static _$Ei(){if(this.hasOwnProperty(Mt("elementProperties")))return;const t=vn(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Mt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Mt("properties"))){const e=this.properties,i=[...mn(e),...gn(e)];for(const s of i)this.createProperty(s,e[s])}const t=this[Symbol.metadata];if(t!==null){const e=litPropertyMetadata.get(t);if(e!==void 0)for(const[i,s]of e)this.elementProperties.set(i,s)}this._$Eh=new Map;for(const[e,i]of this.elementProperties){const s=this._$Eu(e,i);s!==void 0&&this._$Eh.set(s,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const s of i)e.unshift(ys(s))}else t!==void 0&&e.push(ys(t));return e}static _$Eu(t,e){const i=e.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(e=>e(this))}addController(t){var e;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((e=t.hostConnected)==null||e.call(t))}removeController(t){var e;(e=this._$EO)==null||e.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return hn(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(e=>{var i;return(i=e.hostConnected)==null?void 0:i.call(e)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(e=>{var i;return(i=e.hostDisconnected)==null?void 0:i.call(e)})}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$EC(t,e){var i;const s=this.constructor.elementProperties.get(t),r=this.constructor._$Eu(t,s);if(r!==void 0&&s.reflect===!0){const a=(((i=s.converter)==null?void 0:i.toAttribute)!==void 0?s.converter:re).toAttribute(e,s.type);this._$Em=t,a==null?this.removeAttribute(r):this.setAttribute(r,a),this._$Em=null}}_$AK(t,e){var i;const s=this.constructor,r=s._$Eh.get(t);if(r!==void 0&&this._$Em!==r){const a=s.getPropertyOptions(r),o=typeof a.converter=="function"?{fromAttribute:a.converter}:((i=a.converter)==null?void 0:i.fromAttribute)!==void 0?a.converter:re;this._$Em=r,this[r]=o.fromAttribute(e,a.type),this._$Em=null}}requestUpdate(t,e,i){if(t!==void 0){if(i??(i=this.constructor.getPropertyOptions(t)),!(i.hasChanged??Ye)(this[t],e))return;this.P(t,e,i)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(t,e,i){this._$AL.has(t)||this._$AL.set(t,e),i.reflect===!0&&this._$Em!==t&&(this._$Ej??(this._$Ej=new Set)).add(t)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[r,a]of this._$Ep)this[r]=a;this._$Ep=void 0}const s=this.constructor.elementProperties;if(s.size>0)for(const[r,a]of s)a.wrapped!==!0||this._$AL.has(r)||this[r]===void 0||this.P(r,this[r],a)}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),(t=this._$EO)==null||t.forEach(s=>{var r;return(r=s.hostUpdate)==null?void 0:r.call(s)}),this.update(i)):this._$EU()}catch(s){throw e=!1,this._$EU(),s}e&&this._$AE(i)}willUpdate(t){}_$AE(t){var e;(e=this._$EO)==null||e.forEach(i=>{var s;return(s=i.hostUpdated)==null?void 0:s.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Ej&&(this._$Ej=this._$Ej.forEach(e=>this._$EC(e,this[e]))),this._$EU()}updated(t){}firstUpdated(t){}};ht.elementStyles=[],ht.shadowRootOptions={mode:"open"},ht[Mt("elementProperties")]=new Map,ht[Mt("finalized")]=new Map,xs==null||xs({ReactiveElement:ht}),(gt.reactiveElementVersions??(gt.reactiveElementVersions=[])).push("2.0.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ae=globalThis,oe=ae.trustedTypes,ks=oe?oe.createPolicy("lit-html",{createHTML:n=>n}):void 0,ci="$lit$",B=`lit$${Math.random().toFixed(9).slice(2)}$`,di="?"+B,_n=`<${di}>`,st=document,Nt=()=>st.createComment(""),Lt=n=>n===null||typeof n!="object"&&typeof n!="function",hi=Array.isArray,yn=n=>hi(n)||typeof(n==null?void 0:n[Symbol.iterator])=="function",ke=`[ 	
\f\r]`,zt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ss=/-->/g,As=/>/g,Z=RegExp(`>|${ke}(?:([^\\s"'>=/]+)(${ke}*=${ke}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Es=/'/g,Ps=/"/g,pi=/^(?:script|style|textarea|title)$/i,$n=n=>(t,...e)=>({_$litType$:n,strings:t,values:e}),Ot=$n(1),vt=Symbol.for("lit-noChange"),O=Symbol.for("lit-nothing"),Cs=new WeakMap,Q=st.createTreeWalker(st,129);function ui(n,t){if(!Array.isArray(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return ks!==void 0?ks.createHTML(t):t}const xn=(n,t)=>{const e=n.length-1,i=[];let s,r=t===2?"<svg>":"",a=zt;for(let o=0;o<e;o++){const l=n[o];let f,m,p=-1,c=0;for(;c<l.length&&(a.lastIndex=c,m=a.exec(l),m!==null);)c=a.lastIndex,a===zt?m[1]==="!--"?a=Ss:m[1]!==void 0?a=As:m[2]!==void 0?(pi.test(m[2])&&(s=RegExp("</"+m[2],"g")),a=Z):m[3]!==void 0&&(a=Z):a===Z?m[0]===">"?(a=s??zt,p=-1):m[1]===void 0?p=-2:(p=a.lastIndex-m[2].length,f=m[1],a=m[3]===void 0?Z:m[3]==='"'?Ps:Es):a===Ps||a===Es?a=Z:a===Ss||a===As?a=zt:(a=Z,s=void 0);const d=a===Z&&n[o+1].startsWith("/>")?" ":"";r+=a===zt?l+_n:p>=0?(i.push(f),l.slice(0,p)+ci+l.slice(p)+B+d):l+B+(p===-2?o:d)}return[ui(n,r+(n[e]||"<?>")+(t===2?"</svg>":"")),i]};let Ue=class fi{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let r=0,a=0;const o=t.length-1,l=this.parts,[f,m]=xn(t,e);if(this.el=fi.createElement(f,i),Q.currentNode=this.el.content,e===2){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(s=Q.nextNode())!==null&&l.length<o;){if(s.nodeType===1){if(s.hasAttributes())for(const p of s.getAttributeNames())if(p.endsWith(ci)){const c=m[a++],d=s.getAttribute(p).split(B),u=/([.?@])?(.*)/.exec(c);l.push({type:1,index:r,name:u[2],strings:d,ctor:u[1]==="."?kn:u[1]==="?"?Sn:u[1]==="@"?An:ve}),s.removeAttribute(p)}else p.startsWith(B)&&(l.push({type:6,index:r}),s.removeAttribute(p));if(pi.test(s.tagName)){const p=s.textContent.split(B),c=p.length-1;if(c>0){s.textContent=oe?oe.emptyScript:"";for(let d=0;d<c;d++)s.append(p[d],Nt()),Q.nextNode(),l.push({type:2,index:++r});s.append(p[c],Nt())}}}else if(s.nodeType===8)if(s.data===di)l.push({type:2,index:r});else{let p=-1;for(;(p=s.data.indexOf(B,p+1))!==-1;)l.push({type:7,index:r}),p+=B.length-1}r++}}static createElement(t,e){const i=st.createElement("template");return i.innerHTML=t,i}};function bt(n,t,e=n,i){var s,r;if(t===vt)return t;let a=i!==void 0?(s=e._$Co)==null?void 0:s[i]:e._$Cl;const o=Lt(t)?void 0:t._$litDirective$;return(a==null?void 0:a.constructor)!==o&&((r=a==null?void 0:a._$AO)==null||r.call(a,!1),o===void 0?a=void 0:(a=new o(n),a._$AT(n,e,i)),i!==void 0?(e._$Co??(e._$Co=[]))[i]=a:e._$Cl=a),a!==void 0&&(t=bt(n,a._$AS(n,t.values),a,i)),t}let wn=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,s=((t==null?void 0:t.creationScope)??st).importNode(e,!0);Q.currentNode=s;let r=Q.nextNode(),a=0,o=0,l=i[0];for(;l!==void 0;){if(a===l.index){let f;l.type===2?f=new Be(r,r.nextSibling,this,t):l.type===1?f=new l.ctor(r,l.name,l.strings,this,t):l.type===6&&(f=new En(r,this,t)),this._$AV.push(f),l=i[++o]}a!==(l==null?void 0:l.index)&&(r=Q.nextNode(),a++)}return Q.currentNode=st,s}p(t){let e=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}},Be=class mi{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=O,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=(s==null?void 0:s.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=bt(this,t,e),Lt(t)?t===O||t==null||t===""?(this._$AH!==O&&this._$AR(),this._$AH=O):t!==this._$AH&&t!==vt&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):yn(t)?this.k(t):this._(t)}S(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.S(t))}_(t){this._$AH!==O&&Lt(this._$AH)?this._$AA.nextSibling.data=t:this.T(st.createTextNode(t)),this._$AH=t}$(t){var e;const{values:i,_$litType$:s}=t,r=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=Ue.createElement(ui(s.h,s.h[0]),this.options)),s);if(((e=this._$AH)==null?void 0:e._$AD)===r)this._$AH.p(i);else{const a=new wn(r,this),o=a.u(this.options);a.p(i),this.T(o),this._$AH=a}}_$AC(t){let e=Cs.get(t.strings);return e===void 0&&Cs.set(t.strings,e=new Ue(t)),e}k(t){hi(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const r of t)s===e.length?e.push(i=new mi(this.S(Nt()),this.S(Nt()),this,this.options)):i=e[s],i._$AI(r),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,e);t&&t!==this._$AB;){const s=t.nextSibling;t.remove(),t=s}}setConnected(t){var e;this._$AM===void 0&&(this._$Cv=t,(e=this._$AP)==null||e.call(this,t))}},ve=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,r){this.type=1,this._$AH=O,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=O}_$AI(t,e=this,i,s){const r=this.strings;let a=!1;if(r===void 0)t=bt(this,t,e,0),a=!Lt(t)||t!==this._$AH&&t!==vt,a&&(this._$AH=t);else{const o=t;let l,f;for(t=r[0],l=0;l<r.length-1;l++)f=bt(this,o[i+l],e,l),f===vt&&(f=this._$AH[l]),a||(a=!Lt(f)||f!==this._$AH[l]),f===O?t=O:t!==O&&(t+=(f??"")+r[l+1]),this._$AH[l]=f}a&&!s&&this.j(t)}j(t){t===O?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},kn=class extends ve{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===O?void 0:t}},Sn=class extends ve{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==O)}},An=class extends ve{constructor(t,e,i,s,r){super(t,e,i,s,r),this.type=5}_$AI(t,e=this){if((t=bt(this,t,e,0)??O)===vt)return;const i=this._$AH,s=t===O&&i!==O||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==O&&(i===O||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e;typeof this._$AH=="function"?this._$AH.call(((e=this.options)==null?void 0:e.host)??this.element,t):this._$AH.handleEvent(t)}},En=class{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){bt(this,t)}};const zs=ae.litHtmlPolyfillSupport;zs==null||zs(Ue,Be),(ae.litHtmlVersions??(ae.litHtmlVersions=[])).push("3.1.3");const Pn=(n,t,e)=>{const i=(e==null?void 0:e.renderBefore)??t;let s=i._$litPart$;if(s===void 0){const r=(e==null?void 0:e.renderBefore)??null;i._$litPart$=s=new Be(t.insertBefore(Nt(),r),r,void 0,e??{})}return s._$AI(n),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ut=class extends ht{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t;const e=super.createRenderRoot();return(t=this.renderOptions).renderBefore??(t.renderBefore=e.firstChild),e}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Pn(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return vt}};ut._$litElement$=!0,ut.finalized=!0,(gs=globalThis.litElementHydrateSupport)==null||gs.call(globalThis,{LitElement:ut});const Os=globalThis.litElementPolyfillSupport;Os==null||Os({LitElement:ut});(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push("4.0.5");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Cn={attribute:!0,type:String,converter:re,reflect:!1,hasChanged:Ye},zn=(n=Cn,t,e)=>{const{kind:i,metadata:s}=e;let r=globalThis.litPropertyMetadata.get(s);if(r===void 0&&globalThis.litPropertyMetadata.set(s,r=new Map),r.set(e.name,n),i==="accessor"){const{name:a}=e;return{set(o){const l=t.get.call(this);t.set.call(this,o),this.requestUpdate(a,l,n)},init(o){return o!==void 0&&this.P(a,void 0,n),o}}}if(i==="setter"){const{name:a}=e;return function(o){const l=this[a];t.call(this,o),this.requestUpdate(a,l,n)}}throw Error("Unsupported decorator location: "+i)};function gi(n){return(t,e)=>typeof e=="object"?zn(n,t,e):((i,s,r)=>{const a=s.hasOwnProperty(r);return s.constructor.createProperty(r,a?{...i,wrapped:!0}:i),a?Object.getOwnPropertyDescriptor(s,r):void 0})(n,t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function vi(n){return gi({...n,state:!0,attribute:!1})}function On(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}function Tn(n){throw new Error('Could not dynamically require "'+n+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var bi={};(function(n){var t=function(){var e=function(p,c,d,u){for(d=d||{},u=p.length;u--;d[p[u]]=c);return d},i=[1,9],s=[1,10],r=[1,11],a=[1,12],o=[5,11,12,13,14,15],l={trace:function(){},yy:{},symbols_:{error:2,root:3,expressions:4,EOF:5,expression:6,optional:7,literal:8,splat:9,param:10,"(":11,")":12,LITERAL:13,SPLAT:14,PARAM:15,$accept:0,$end:1},terminals_:{2:"error",5:"EOF",11:"(",12:")",13:"LITERAL",14:"SPLAT",15:"PARAM"},productions_:[0,[3,2],[3,1],[4,2],[4,1],[6,1],[6,1],[6,1],[6,1],[7,3],[8,1],[9,1],[10,1]],performAction:function(c,d,u,b,_,k,G){var R=k.length-1;switch(_){case 1:return new b.Root({},[k[R-1]]);case 2:return new b.Root({},[new b.Literal({value:""})]);case 3:this.$=new b.Concat({},[k[R-1],k[R]]);break;case 4:case 5:this.$=k[R];break;case 6:this.$=new b.Literal({value:k[R]});break;case 7:this.$=new b.Splat({name:k[R]});break;case 8:this.$=new b.Param({name:k[R]});break;case 9:this.$=new b.Optional({},[k[R-1]]);break;case 10:this.$=c;break;case 11:case 12:this.$=c.slice(1);break}},table:[{3:1,4:2,5:[1,3],6:4,7:5,8:6,9:7,10:8,11:i,13:s,14:r,15:a},{1:[3]},{5:[1,13],6:14,7:5,8:6,9:7,10:8,11:i,13:s,14:r,15:a},{1:[2,2]},e(o,[2,4]),e(o,[2,5]),e(o,[2,6]),e(o,[2,7]),e(o,[2,8]),{4:15,6:4,7:5,8:6,9:7,10:8,11:i,13:s,14:r,15:a},e(o,[2,10]),e(o,[2,11]),e(o,[2,12]),{1:[2,1]},e(o,[2,3]),{6:14,7:5,8:6,9:7,10:8,11:i,12:[1,16],13:s,14:r,15:a},e(o,[2,9])],defaultActions:{3:[2,2],13:[2,1]},parseError:function(c,d){if(d.recoverable)this.trace(c);else{let u=function(b,_){this.message=b,this.hash=_};throw u.prototype=Error,new u(c,d)}},parse:function(c){var d=this,u=[0],b=[null],_=[],k=this.table,G="",R=0,ot=0,Pt=2,S=1,A=_.slice.call(arguments,1),g=Object.create(this.lexer),y={yy:{}};for(var $ in this.yy)Object.prototype.hasOwnProperty.call(this.yy,$)&&(y.yy[$]=this.yy[$]);g.setInput(c,y.yy),y.yy.lexer=g,y.yy.parser=this,typeof g.yylloc>"u"&&(g.yylloc={});var L=g.yylloc;_.push(L);var D=g.options&&g.options.ranges;typeof y.yy.parseError=="function"?this.parseError=y.yy.parseError:this.parseError=Object.getPrototypeOf(this).parseError;for(var F=function(){var ct;return ct=g.lex()||S,typeof ct!="number"&&(ct=d.symbols_[ct]||ct),ct},w,x,C,$e,lt={},te,Y,ms,ee;;){if(x=u[u.length-1],this.defaultActions[x]?C=this.defaultActions[x]:((w===null||typeof w>"u")&&(w=F()),C=k[x]&&k[x][w]),typeof C>"u"||!C.length||!C[0]){var xe="";ee=[];for(te in k[x])this.terminals_[te]&&te>Pt&&ee.push("'"+this.terminals_[te]+"'");g.showPosition?xe="Parse error on line "+(R+1)+`:
`+g.showPosition()+`
Expecting `+ee.join(", ")+", got '"+(this.terminals_[w]||w)+"'":xe="Parse error on line "+(R+1)+": Unexpected "+(w==S?"end of input":"'"+(this.terminals_[w]||w)+"'"),this.parseError(xe,{text:g.match,token:this.terminals_[w]||w,line:g.yylineno,loc:L,expected:ee})}if(C[0]instanceof Array&&C.length>1)throw new Error("Parse Error: multiple actions possible at state: "+x+", token: "+w);switch(C[0]){case 1:u.push(w),b.push(g.yytext),_.push(g.yylloc),u.push(C[1]),w=null,ot=g.yyleng,G=g.yytext,R=g.yylineno,L=g.yylloc;break;case 2:if(Y=this.productions_[C[1]][1],lt.$=b[b.length-Y],lt._$={first_line:_[_.length-(Y||1)].first_line,last_line:_[_.length-1].last_line,first_column:_[_.length-(Y||1)].first_column,last_column:_[_.length-1].last_column},D&&(lt._$.range=[_[_.length-(Y||1)].range[0],_[_.length-1].range[1]]),$e=this.performAction.apply(lt,[G,ot,R,y.yy,C[1],b,_].concat(A)),typeof $e<"u")return $e;Y&&(u=u.slice(0,-1*Y*2),b=b.slice(0,-1*Y),_=_.slice(0,-1*Y)),u.push(this.productions_[C[1]][0]),b.push(lt.$),_.push(lt._$),ms=k[u[u.length-2]][u[u.length-1]],u.push(ms);break;case 3:return!0}}return!0}},f=function(){var p={EOF:1,parseError:function(d,u){if(this.yy.parser)this.yy.parser.parseError(d,u);else throw new Error(d)},setInput:function(c,d){return this.yy=d||this.yy||{},this._input=c,this._more=this._backtrack=this.done=!1,this.yylineno=this.yyleng=0,this.yytext=this.matched=this.match="",this.conditionStack=["INITIAL"],this.yylloc={first_line:1,first_column:0,last_line:1,last_column:0},this.options.ranges&&(this.yylloc.range=[0,0]),this.offset=0,this},input:function(){var c=this._input[0];this.yytext+=c,this.yyleng++,this.offset++,this.match+=c,this.matched+=c;var d=c.match(/(?:\r\n?|\n).*/g);return d?(this.yylineno++,this.yylloc.last_line++):this.yylloc.last_column++,this.options.ranges&&this.yylloc.range[1]++,this._input=this._input.slice(1),c},unput:function(c){var d=c.length,u=c.split(/(?:\r\n?|\n)/g);this._input=c+this._input,this.yytext=this.yytext.substr(0,this.yytext.length-d),this.offset-=d;var b=this.match.split(/(?:\r\n?|\n)/g);this.match=this.match.substr(0,this.match.length-1),this.matched=this.matched.substr(0,this.matched.length-1),u.length-1&&(this.yylineno-=u.length-1);var _=this.yylloc.range;return this.yylloc={first_line:this.yylloc.first_line,last_line:this.yylineno+1,first_column:this.yylloc.first_column,last_column:u?(u.length===b.length?this.yylloc.first_column:0)+b[b.length-u.length].length-u[0].length:this.yylloc.first_column-d},this.options.ranges&&(this.yylloc.range=[_[0],_[0]+this.yyleng-d]),this.yyleng=this.yytext.length,this},more:function(){return this._more=!0,this},reject:function(){if(this.options.backtrack_lexer)this._backtrack=!0;else return this.parseError("Lexical error on line "+(this.yylineno+1)+`. You can only invoke reject() in the lexer when the lexer is of the backtracking persuasion (options.backtrack_lexer = true).
...
`+this.showPosition(),{text:"",token:null,line:this.yylineno})},lex:function(){var d=this.next();return d||this.lex()},begin:function(d){this.conditionStack.push(d)},popState:function(){var d=this.conditionStack.length-1;return d>0?this.conditionStack.pop():this.conditionStack[0]},_currentRules:function(){return this.conditionStack.length&&this.conditionStack[this.conditionStack.length-1]?this.conditions[this.conditionStack[this.conditionStack.length-1]].rules:this.conditions.INITIAL.rules},topState:function(d){return d=this.conditionStack.length-1-Math.abs(d||0),d>=0?this.conditionStack[d]:"INITIAL"},pushState:function(d){this.begin(d)},stateStackSize:function(){return this.conditionStack.length},options:{},performAction:function(d,u,b,_){switch(b){case 0:return"(";case 1:return")";case 2:return"SPLAT";case 3:return"PARAM";case 4:return"LITERAL";case 5:return"LITERAL";case 6:return"EOF"}},rules:[/^(?:\()/,/^(?:\))/,/^(?:\*+\w+)/,/^(?::+\w+)/,/^(?:[\w%\-~\n]+)/,/^(?:.)/,/^(?:$)/],conditions:{INITIAL:{rules:[0,1,2,3,4,5,6],inclusive:!0}}};return p}();l.lexer=f;function m(){this.yy={}}return m.prototype=l,l.Parser=m,new m}();typeof Tn<"u"&&(n.parser=t,n.Parser=t.Parser,n.parse=function(){return t.parse.apply(t,arguments)})})(bi);function dt(n){return function(t,e){return{displayName:n,props:t,children:e||[]}}}var _i={Root:dt("Root"),Concat:dt("Concat"),Literal:dt("Literal"),Splat:dt("Splat"),Param:dt("Param"),Optional:dt("Optional")},yi=bi.parser;yi.yy=_i;var Rn=yi,Un=Object.keys(_i);function Mn(n){return Un.forEach(function(t){if(typeof n[t]>"u")throw new Error("No handler defined for "+t.displayName)}),{visit:function(t,e){return this.handlers[t.displayName].call(this,t,e)},handlers:n}}var $i=Mn,In=$i,jn=/[\-{}\[\]+?.,\\\^$|#\s]/g;function xi(n){this.captures=n.captures,this.re=n.re}xi.prototype.match=function(n){var t=this.re.exec(n),e={};if(t)return this.captures.forEach(function(i,s){typeof t[s+1]>"u"?e[i]=void 0:e[i]=decodeURIComponent(t[s+1])}),e};var Nn=In({Concat:function(n){return n.children.reduce((function(t,e){var i=this.visit(e);return{re:t.re+i.re,captures:t.captures.concat(i.captures)}}).bind(this),{re:"",captures:[]})},Literal:function(n){return{re:n.props.value.replace(jn,"\\$&"),captures:[]}},Splat:function(n){return{re:"([^?]*?)",captures:[n.props.name]}},Param:function(n){return{re:"([^\\/\\?]+)",captures:[n.props.name]}},Optional:function(n){var t=this.visit(n.children[0]);return{re:"(?:"+t.re+")?",captures:t.captures}},Root:function(n){var t=this.visit(n.children[0]);return new xi({re:new RegExp("^"+t.re+"(?=\\?|$)"),captures:t.captures})}}),Ln=Nn,Dn=$i,Hn=Dn({Concat:function(n,t){var e=n.children.map((function(i){return this.visit(i,t)}).bind(this));return e.some(function(i){return i===!1})?!1:e.join("")},Literal:function(n){return decodeURI(n.props.value)},Splat:function(n,t){return t[n.props.name]?t[n.props.name]:!1},Param:function(n,t){return t[n.props.name]?t[n.props.name]:!1},Optional:function(n,t){var e=this.visit(n.children[0],t);return e||""},Root:function(n,t){t=t||{};var e=this.visit(n.children[0],t);return e?encodeURI(e):!1}}),qn=Hn,Fn=Rn,Xn=Ln,Yn=qn;Gt.prototype=Object.create(null);Gt.prototype.match=function(n){var t=Xn.visit(this.ast),e=t.match(n);return e||!1};Gt.prototype.reverse=function(n){return Yn.visit(this.ast,n)};function Gt(n){var t;if(this?t=this:t=Object.create(Gt.prototype),typeof n>"u")throw new Error("A route spec is required");return t.spec=n,t.ast=Fn.parse(n),t}var Bn=Gt,Wn=Bn,Jn=Wn;const Vn=On(Jn);var Gn=Object.defineProperty,wi=(n,t,e,i)=>{for(var s=void 0,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=a(t,e,s)||s);return s&&Gn(t,e,s),s};class Dt extends ut{constructor(t,e,i=""){super(),this._cases=[],this._fallback=()=>Ot`
  ...
  `;const Si=class Ai extends HTMLElement{constructor(){super(),this._array=[],ge(Ai.template).attach(this),this.addEventListener("input-array:add",t=>{t.stopPropagation(),this.append(Ei("",this._array.length))}),this.addEventListener("input-array:remove",t=>{t.stopPropagation(),this.removeClosestItem(t.target)}),this.addEventListener("change",t=>{t.stopPropagation();const e=t.target;if(e&&e!==this){const i=new Event("change",{bubbles:!0}),s=e.value,r=e.closest("label");if(r){const a=Array.from(this.children).indexOf(r);this._array[a]=s,this.dispatchEvent(i)}}}),this.addEventListener("click",t=>{Te(t,"button.add")?ne(t,"input-array:add"):Te(t,"button.remove")&&ne(t,"input-array:remove")})}get name(){return this.getAttribute("name")}get value(){return this._array}set value(t){this._array=Array.isArray(t)?t:[t],tr(this._array,this)}removeClosestItem(t){const e=t.closest("label");if(console.log("Removing closest item:",e,t),e){const i=Array.from(this.children).indexOf(e);this._array.splice(i,1),e.remove()}}};Si.template=Vt`
    <template>
      <ul>
        <slot></slot>
      </ul>
 ...
 */function v(n){return z({...n,state:!0,attribute:!1})}var Gr=Object.defineProperty,Ui=(n,t,e,i)=>{for(var s=void 0,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=a(t,e,s)||s);return s&&Gr(t,e,s),s};const es=class es extends q{constructor(){super(...arguments),this.display_name="Status: 401",this.curr_href=window.location.href,this._authObserver=new et(this,"acorn:auth"),this._historyObserver=new et(this,"acorn:history")}displayNameTemplate(){return this.display_name==="Status: 401"||this.display_name==="Status: 403"?h`
        ...
        <nav class="sidebar">
            ...
            <ul class="bottom">
                ...
                <li>
                    <a href="/login.html?next=${this.curr_href}" @click=${Fs}>
  ...
  `;let Xt=es;Ui([z({attribute:!1})],Xt.prototype,"display_name");Ui([z()],Xt.prototype,"curr_href");function Fs(n){Jt.relay(n,"auth:message",["auth/signout"])}at({"restful-form":qe.FormElement});class Zr extends q{render(){return h`
...
`+C)})})(this,0,$);break;case"color":L.style.fill=$||"";break;case"size":(function(D,F,w){var x=D._state;x.size&&(x.$iconHolder.style.width=x.$iconHolder.style.height="",x.size=x.sizeType=null),w&&!/^(xs|sm|md|lg)$/.test(x.size)&&(x.size=w.trim(),x.$iconHolder.style.width=x.$iconHolder.style.height=x.size)})(this,0,$);break;case"rotate":y&&L.classList.remove("bx-rotate-"+y),$&&L.classList.add("bx-rotate-"+$);break;case"flip":y&&L.classList.remove("bx-flip-"+y),$&&L.classList.add("bx-flip-"+$);break;case"animation":y&&L.classList.remove("bx-"+y),$&&L.classList.add("bx-"+$)}}},{key:"connectedCallback",value:function(){ot()&&k.ShadyCSS.styleElement(this)}}]),A}());s.default=Pt,Pt.define()}])},n.exports=e()})})(Qr);const ss=class ss extends j{constructor(){super("acorn:model")}render(){return h`
    ...
    `}};ns.styles=[M,I,P`
        ...
        `];let H=ns;X([v()],H.prototype,"appointments",1);X([v()],H.prototype,"services",1);X([v()],H.prototype,"showing_total",1);X([v()],H.prototype,"service_options",1);X([v()],H.prototype,"from_service_date",2);X([v()],H.prototype,"to_service_date",2);X([v()],H.prototype,"per_page",2);X([v()],H.prototype,"page",2);X([v()],H.prototype,"filter_status_ids",2);X([v()],H.prototype,"filter_service_ids",2);var oa=Object.defineProperty,la=Object.getOwnPropertyDescriptor,Mi=(n,t,e,i)=>{for(var s=la(t,e),r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=a(t,e,s)||s);return s&&oa(t,e,s),s};const rs=class rs extends j{get roles(){return this.model.roles}get showing_total(){return this.roles?this.roles.length:0}constructor(){super("acorn:model")}connectedCallback(){super.connectedCallback(),this.updateRoles()}updateRoles(){this.dispatchMessage(["roles/",{}])}handleInputChange(t,e,i){const s=t.target;if(i==="priority")if(s.value)e[i]=parseInt(s.value);else return;else if(i==="can_lead_team"||i==="can_clean")e[i]=s.checked;else{if(i==="role_id")return;e[i]=s.value}this.dispatchMessage(["roles/save",{role_id:e.role_id,role:e}])}render(){const t=i=>h`
            <tr>
                <td class="center">
                    <input
                    type="number"
    ...
    `}};pe.uses=at({"add-staff-modal":nt,"add-appointment-modal":rt}),pe.styles=[M,I,P`
            section {
                background-color: var(--background-color-accent);
                border-radius: var(--border-size-radius);
                padding: var(--spacing-size-small) var(--spacing-size-medium);
    ...
    `}};ds.styles=[M,I,P`
        ...
        `];let V=ds;Qt([z({attribute:!0,reflect:!0})],V.prototype,"services",2);Qt([z()],V.prototype,"date",2);Qt([v()],V.prototype,"appointments",1);Qt([v()],V.prototype,"appointment_omissions",2);Qt([v()],V.prototype,"appointment_options",1);var wa=Object.defineProperty,Ii=(n,t,e,i)=>{for(var s=void 0,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=a(t,e,s)||s);return s&&wa(t,e,s),s};const hs=class hs extends q{attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="code"&&e&&e!==i&&i&&(i.split(":")[0]==="no-error"?e.split(":")[1]!==i.split(":")[1]&&this.requestPlanUpdate():this.show())}requestPlanUpdate(){const t=new CustomEvent("build-error-dialog:no-error",{bubbles:!0,composed:!0,detail:{}});this.dispatchEvent(t)}closeDialog(){this.shadowRoot.querySelector("dialog").close()}show(){this.shadowRoot.querySelector("dialog").show()}render(){const t=i=>i?h`
    ...
    `}};hs.styles=[M,I,P`
        ...
        `];let Bt=hs;Ii([z({attribute:!1})],Bt.prototype,"error");Ii([z()],Bt.prototype,"code");var ka=Object.defineProperty,Sa=(n,t,e,i)=>{for(var s=void 0,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=a(t,e,s)||s);return s&&ka(t,e,s),s};const ps=class ps extends q{closeDialog(){this.shadowRoot.querySelector("dialog").close()}show(){console.log("Showing Info ***"),this.shadowRoot.querySelector("dialog").show()}render(){return h`
        <div>
            <button @click=${this.show}>
    ...
    `}};ps.styles=[M,I,P`
        ...
        `];let de=ps;Sa([z()],de.prototype,"name");var Aa=Object.defineProperty,Ea=Object.getOwnPropertyDescriptor,ts=(n,t,e,i)=>{for(var s=i>1?void 0:i?Ea(t,e):t,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=(i?a(t,e,s):a(s))||s);return i&&s&&Aa(t,e,s),s};const us=class us extends j{constructor(){super("acorn:model"),this.handleVisibilityChange=()=>{document.visibilityState==="visible"&&this.updateUnscheduled()}}get unscheduled(){var t;if(this.model.plans){const e=new Set(this.model.plans.flatMap(i=>i.appointments.map(s=>s.appointment_id)));return(t=this.model.unscheduled)==null?void 0:t.filter(i=>!e.has(i.appointment_id))}return this.model.unscheduled}connectedCallback(){super.connectedCallback(),document.addEventListener("visibilitychange",this.handleVisibilityChange)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("visibilitychange",this.handleVisibilityChange)}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="date"&&e!==i&&i&&this.updateUnscheduled()}updateUnscheduled(){this.dispatchMessage(["appointments/select-unscheduled",{from_service_date:this.date,to_service_date:this.date,per_page:100,page:0,filter_status_ids:[1,2],filter_service_ids:this.services,show_unscheduled:!0}])}closeDialog(){this.shadowRoot.querySelector("dialog").close()}showModal(){this.shadowRoot.querySelector("dialog").showModal()}render(){const t=this.unscheduled||[];return h`
        <div>
            ${(i=>i.length?h`
                <button @click=${this.showModal}>
                    <div class="bubble-container">
    ...
    `}};ue.uses=at({"plan-view":wt,"available-modal":kt,"omissions-modal":V,"build-error-dialog":Bt,"info-dialog":de,"unscheduled-modal":St}),ue.styles=[M,I,P`
        ...
        `];let U=ue;N([v()],U.prototype,"plans",1);N([v()],U.prototype,"services",1);N([v()],U.prototype,"build_error",1);N([v()],U.prototype,"showing_total",1);N([v()],U.prototype,"service_options",1);N([v()],U.prototype,"from_plan_date",2);N([v()],U.prototype,"per_page",2);N([v()],U.prototype,"page",2);N([v()],U.prototype,"filter_service_ids",2);N([v()],U.prototype,"routing_type",2);N([v()],U.prototype,"cleaning_window",2);N([v()],U.prototype,"max_hours",2);N([v()],U.prototype,"target_staff_count",2);N([v()],U.prototype,"duplicate_appointment_ids",1);var za=Object.defineProperty,Oa=Object.getOwnPropertyDescriptor,Et=(n,t,e,i)=>{for(var s=i>1?void 0:i?Oa(t,e):t,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=(i?a(t,e,s):a(s))||s);return i&&s&&za(t,e,s),s};const ji=P`
div.detail-header {
    padding-left: var(--spacing-size-small);
}
...
`,fs=class fs extends q{render(){return h`
    <div class="page">
        <header>
            <h1>
    ...
    `];let he=fs;Et([z()],he.prototype,"property",2);const fe=class fe extends q{render(){return h`
    <div class="page">
        <header>
            <h1>
                <slot name="property_name_header"><span>Property View</span></slot>
    ...
    `}};fe.uses=at({"mu-form":tn.Element,"input-array":er.Element}),fe.styles=[M,I,ji,P`
        mu-form {
        grid-column: key / end;
        }
        mu-form input {
    ...
    `];let Wt=fe;Et([z()],Wt.prototype,"property",2);Et([z({attribute:!1})],Wt.prototype,"init",2);const me=class me extends j{constructor(){super("acorn:model"),this.edit=!1,this.properties_id=0}get property(){return this.model.property}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="properties-id"&&e!==i&&i&&(console.log("Property Page:",i),this.dispatchMessage(["properties/select",{properties_id:parseInt(i)}]))}render(){const{properties_id:t,property_name:e,address:i,status:s,estimated_cleaning_mins:r,double_unit:a=[]}=this.property||{properties_id:0},o=a.map(f=>h`
        <li>${f}</li>
        `),l=h`
    ...
    `;return this.edit?h`
        ...
        `}_handleSubmit(t){console.log("Handling submit of mu-form"),this.dispatchMessage(["properties/save",{properties_id:this.properties_id,property:t.detail,onSuccess:()=>ii.dispatch(this,"history/navigate",{href:`/app/property/${this.properties_id}`}),onFailure:e=>console.log("ERROR:",e)}])}};me.uses=at({"property-viewer":he,"property-editor":Wt}),me.styles=[M,I,P`
        li {
            width: max-content;
            background-color: var(--background-color);
            border-radius: var(--border-size-radius);
    ...
    `];let At=me;Et([z({type:Boolean,reflect:!0})],At.prototype,"edit",2);Et([z({attribute:"properties-id",reflect:!0,type:Number})],At.prototype,"properties_id",2);Et([v()],At.prototype,"property",1);const Ta=[{path:"/app/appointments",view:()=>h`
    ...
    `},{path:"/",redirect:"/app"}];at({"mu-auth":E.Provider,"mu-store":class extends ln.Provider{constructor(){super(Sr,kr,"acorn:auth")}},"mu-history":ii.Provider,"mu-switch":class extends Zn.Element{constructor(){super(Ta,"acorn:history","acorn:auth")}},"side-bar":Xt,"login-form":Zr,"signup-form":Kr,"restful-form":qe.FormElement,"landing-view":Me,"staff-view":$t,"appointments-view":H,"roles-view":Yt,"properties-view":xt,"plans-view":U,"property-view":At});export{E as a,at as d,Jt as e};
