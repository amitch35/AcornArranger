 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ie=globalThis,ne=ie.trustedTypes,xs=ne?ne.createPolicy("lit-html",{createHTML:n=>n}):void 0,ii="$lit$",B=`lit$${Math.random().toFixed(9).slice(2)}$`,ni="?"+B,hn=`<${ni}>`,et=document,Mt=()=>et.createComment(""),It=n=>n===null||typeof n!="object"&&typeof n!="function",ri=Array.isArray,pn=n=>ri(n)||typeof(n==null?void 0:n[Symbol.iterator])=="function",we=`[ 	
\f\r]`,Et=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ws=/-->/g,ks=/>/g,Z=RegExp(`>|${we}(?:([^\\s"'>=/]+)(${we}*=${we}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ss=/'/g,As=/"/g,ai=/^(?:script|style|textarea|title)$/i,un=n=>(t,...e)=>({_$litType$:n,strings:t,values:e}),ke=un(1),gt=Symbol.for("lit-noChange"),z=Symbol.for("lit-nothing"),Es=new WeakMap,Q=et.createTreeWalker(et,129);function oi(n,t){if(!Array.isArray(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return xs!==void 0?xs.createHTML(t):t}const fn=(n,t)=>{const e=n.length-1,i=[];let s,r=t===2?"<svg>":"",a=Et;for(let o=0;o<e;o++){const l=n[o];let f,m,h=-1,c=0;for(;c<l.length&&(a.lastIndex=c,m=a.exec(l),m!==null);)c=a.lastIndex,a===Et?m[1]==="!--"?a=ws:m[1]!==void 0?a=ks:m[2]!==void 0?(ai.test(m[2])&&(s=RegExp("</"+m[2],"g")),a=Z):m[3]!==void 0&&(a=Z):a===Z?m[0]===">"?(a=s??Et,h=-1):m[1]===void 0?h=-2:(h=a.lastIndex-m[2].length,f=m[1],a=m[3]===void 0?Z:m[3]==='"'?As:Ss):a===As||a===Ss?a=Z:a===ws||a===ks?a=Et:(a=Z,s=void 0);const d=a===Z&&n[o+1].startsWith("/>")?" ":"";r+=a===Et?l+hn:h>=0?(i.push(f),l.slice(0,h)+ii+l.slice(h)+B+d):l+B+(h===-2?o:d)}return[oi(n,r+(n[e]||"<?>")+(t===2?"</svg>":"")),i]};let Me=class li{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let r=0,a=0;const o=t.length-1,l=this.parts,[f,m]=fn(t,e);if(this.el=li.createElement(f,i),Q.currentNode=this.el.content,e===2){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(s=Q.nextNode())!==null&&l.length<o;){if(s.nodeType===1){if(s.hasAttributes())for(const h of s.getAttributeNames())if(h.endsWith(ii)){const c=m[a++],d=s.getAttribute(h).split(B),p=/([.?@])?(.*)/.exec(c);l.push({type:1,index:r,name:p[2],strings:d,ctor:p[1]==="."?gn:p[1]==="?"?vn:p[1]==="@"?bn:ge}),s.removeAttribute(h)}else h.startsWith(B)&&(l.push({type:6,index:r}),s.removeAttribute(h));if(ai.test(s.tagName)){const h=s.textContent.split(B),c=h.length-1;if(c>0){s.textContent=ne?ne.emptyScript:"";for(let d=0;d<c;d++)s.append(h[d],Mt()),Q.nextNode(),l.push({type:2,index:++r});s.append(h[c],Mt())}}}else if(s.nodeType===8)if(s.data===ni)l.push({type:2,index:r});else{let h=-1;for(;(h=s.data.indexOf(B,h+1))!==-1;)l.push({type:7,index:r}),h+=B.length-1}r++}}static createElement(t,e){const i=et.createElement("template");return i.innerHTML=t,i}};function vt(n,t,e=n,i){var s,r;if(t===gt)return t;let a=i!==void 0?(s=e._$Co)==null?void 0:s[i]:e._$Cl;const o=It(t)?void 0:t._$litDirective$;return(a==null?void 0:a.constructor)!==o&&((r=a==null?void 0:a._$AO)==null||r.call(a,!1),o===void 0?a=void 0:(a=new o(n),a._$AT(n,e,i)),i!==void 0?(e._$Co??(e._$Co=[]))[i]=a:e._$Cl=a),a!==void 0&&(t=vt(n,a._$AS(n,t.values),a,i)),t}let mn=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,s=((t==null?void 0:t.creationScope)??et).importNode(e,!0);Q.currentNode=s;let r=Q.nextNode(),a=0,o=0,l=i[0];for(;l!==void 0;){if(a===l.index){let f;l.type===2?f=new Be(r,r.nextSibling,this,t):l.type===1?f=new l.ctor(r,l.name,l.strings,this,t):l.type===6&&(f=new _n(r,this,t)),this._$AV.push(f),l=i[++o]}a!==(l==null?void 0:l.index)&&(r=Q.nextNode(),a++)}return Q.currentNode=et,s}p(t){let e=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}},Be=class ci{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=z,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=(s==null?void 0:s.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=vt(this,t,e),It(t)?t===z||t==null||t===""?(this._$AH!==z&&this._$AR(),this._$AH=z):t!==this._$AH&&t!==gt&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):pn(t)?this.k(t):this._(t)}S(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.S(t))}_(t){this._$AH!==z&&It(this._$AH)?this._$AA.nextSibling.data=t:this.T(et.createTextNode(t)),this._$AH=t}$(t){var e;const{values:i,_$litType$:s}=t,r=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=Me.createElement(oi(s.h,s.h[0]),this.options)),s);if(((e=this._$AH)==null?void 0:e._$AD)===r)this._$AH.p(i);else{const a=new mn(r,this),o=a.u(this.options);a.p(i),this.T(o),this._$AH=a}}_$AC(t){let e=Es.get(t.strings);return e===void 0&&Es.set(t.strings,e=new Me(t)),e}k(t){ri(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const r of t)s===e.length?e.push(i=new ci(this.S(Mt()),this.S(Mt()),this,this.options)):i=e[s],i._$AI(r),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,e);t&&t!==this._$AB;){const s=t.nextSibling;t.remove(),t=s}}setConnected(t){var e;this._$AM===void 0&&(this._$Cv=t,(e=this._$AP)==null||e.call(this,t))}},ge=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,r){this.type=1,this._$AH=z,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=z}_$AI(t,e=this,i,s){const r=this.strings;let a=!1;if(r===void 0)t=vt(this,t,e,0),a=!It(t)||t!==this._$AH&&t!==gt,a&&(this._$AH=t);else{const o=t;let l,f;for(t=r[0],l=0;l<r.length-1;l++)f=vt(this,o[i+l],e,l),f===gt&&(f=this._$AH[l]),a||(a=!It(f)||f!==this._$AH[l]),f===z?t=z:t!==z&&(t+=(f??"")+r[l+1]),this._$AH[l]=f}a&&!s&&this.j(t)}j(t){t===z?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},gn=class extends ge{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===z?void 0:t}},vn=class extends ge{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==z)}},bn=class extends ge{constructor(t,e,i,s,r){super(t,e,i,s,r),this.type=5}_$AI(t,e=this){if((t=vt(this,t,e,0)??z)===gt)return;const i=this._$AH,s=t===z&&i!==z||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==z&&(i===z||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e;typeof this._$AH=="function"?this._$AH.call(((e=this.options)==null?void 0:e.host)??this.element,t):this._$AH.handleEvent(t)}},_n=class{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){vt(this,t)}};const Ps=ie.litHtmlPolyfillSupport;Ps==null||Ps(Me,Be),(ie.litHtmlVersions??(ie.litHtmlVersions=[])).push("3.1.3");const yn=(n,t,e)=>{const i=(e==null?void 0:e.renderBefore)??t;let s=i._$litPart$;if(s===void 0){const r=(e==null?void 0:e.renderBefore)??null;i._$litPart$=s=new Be(t.insertBefore(Mt(),r),r,void 0,e??{})}return s._$AI(n),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+P)})})(this,0,$);break;case"color":j.style.fill=$||"";break;case"size":(function(N,X,w){var x=N._state;x.size&&(x.$iconHolder.style.width=x.$iconHolder.style.height="",x.size=x.sizeType=null),w&&!/^(xs|sm|md|lg)$/.test(x.size)&&(x.size=w.trim(),x.$iconHolder.style.width=x.$iconHolder.style.height=x.size)})(this,0,$);break;case"rotate":y&&j.classList.remove("bx-rotate-"+y),$&&j.classList.add("bx-rotate-"+$);break;case"flip":y&&j.classList.remove("bx-flip-"+y),$&&j.classList.add("bx-flip-"+$);break;case"animation":y&&j.classList.remove("bx-"+y),$&&j.classList.add("bx-"+$)}}},{key:"connectedCallback",value:function(){at()&&k.ShadyCSS.styleElement(this)}}]),A}());s.default=St,St.define()}])},n.exports=e()})})(Wr);const ts=class ts extends D{constructor(){super("acorn:model")}render(){return u`
    ...
    `}};he.uses=rt({"add-staff-modal":it,"add-appointment-modal":nt}),he.styles=[M,I,C`
            section {
                background-color: var(--background-color-accent);
                border-radius: var(--border-size-radius);
                padding: var(--spacing-size-small) var(--spacing-size-medium);
    ...
    `}};pe.uses=rt({"plan-view":Dt,"available-modal":xt,"omissions-modal":V,"build-error-dialog":Ht,"info-dialog":ce}),pe.styles=[M,I,C`
...
`,hs=class hs extends F{render(){return u`
    ...
    `}};ue.uses=rt({"mu-form":Bi.Element,"input-array":Jn.Element}),ue.styles=[M,I,Ci,C`
        mu-form {
        grid-column: key / end;
        }
        mu-form input {
