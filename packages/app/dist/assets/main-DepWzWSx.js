(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function e(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=e(s);fetch(s.href,r)}})();var ps;let Ot=class extends Error{};Ot.prototype.name="InvalidTokenError";function Ii(n){return decodeURIComponent(atob(n).replace(/(.)/g,(t,e)=>{let i=e.charCodeAt(0).toString(16).toUpperCase();return i.length<2&&(i="0"+i),"%"+i}))}function Mi(n){let t=n.replace(/-/g,"+").replace(/_/g,"/");switch(t.length%4){case 0:break;case 2:t+="==";break;case 3:t+="=";break;default:throw new Error("base64 string is not of the correct length")}try{return Ii(t)}catch{return atob(t)}}function Hs(n,t){if(typeof n!="string")throw new Ot("Invalid token specified: must be a string");t||(t={});const e=t.header===!0?0:1,i=n.split(".")[e];if(typeof i!="string")throw new Ot(`Invalid token specified: missing part #${e+1}`);let s;try{s=Mi(i)}catch(r){throw new Ot(`Invalid token specified: invalid base64 for part #${e+1} (${r.message})`)}try{return JSON.parse(s)}catch(r){throw new Ot(`Invalid token specified: invalid json for part #${e+1} (${r.message})`)}}const Ui="mu:context",Ce=`${Ui}:change`;class ji{constructor(t,e){this._proxy=Ni(t,e)}get value(){return this._proxy}set value(t){Object.assign(this._proxy,t)}apply(t){this.value=t(this.value)}}class Ue extends HTMLElement{constructor(t){super(),console.log("Constructing context provider",this),this.context=new ji(t,this),this.style.display="contents"}attach(t){return this.addEventListener(Ce,t),t}detach(t){this.removeEventListener(Ce,t)}}function Ni(n,t){return new Proxy(n,{get:(i,s,r)=>{if(s==="then")return;const o=Reflect.get(i,s,r);return console.log(`Context['${s}'] => `,o),o},set:(i,s,r,o)=>{const a=n[s];console.log(`Context['${s.toString()}'] <= `,r);const l=Reflect.set(i,s,r,o);if(l){let f=new CustomEvent(Ce,{bubbles:!0,cancelable:!0,composed:!0});Object.assign(f,{property:s,oldValue:a,value:r}),t.dispatchEvent(f)}else console.log(`Context['${s}] was not set to ${r}`);return l}})}function Li(n,t){const e=Fs(t,n);return new Promise((i,s)=>{if(e){const r=e.localName;customElements.whenDefined(r).then(()=>i(e))}else s({context:t,reason:`No provider for this context "${t}:`})})}function Fs(n,t){const e=`[provides="${n}"]`;if(!t||t===document.getRootNode())return;const i=t.closest(e);if(i)return i;const s=t.getRootNode();if(s instanceof ShadowRoot)return Fs(n,s.host)}class Di extends CustomEvent{constructor(t,e="mu:message"){super(e,{bubbles:!0,composed:!0,detail:t})}}function Xs(n="mu:message"){return(t,...e)=>t.dispatchEvent(new Di(e,n))}class je{constructor(t,e,i="service:message",s=!0){this._pending=[],this._context=e,this._update=t,this._eventType=i,this._running=s}attach(t){t.addEventListener(this._eventType,e=>{e.stopPropagation();const i=e.detail;this.consume(i)})}start(){this._running||(console.log(`Starting ${this._eventType} service`),this._running=!0,this._pending.forEach(t=>this.process(t)))}apply(t){this._context.apply(t)}consume(t){this._running?this.process(t):(console.log(`Queueing ${this._eventType} message`,t),this._pending.push(t))}process(t){console.log(`Processing ${this._eventType} message`,t);const e=this._update(t,this.apply.bind(this));e&&e(this._context.value)}}function Hi(n){return t=>({...t,...n})}const ze="mu:auth:jwt",qs=class Ys extends je{constructor(t,e){super((i,s)=>this.update(i,s),t,Ys.EVENT_TYPE),this._redirectForLogin=e}update(t,e){switch(t[0]){case"auth/signin":const{token:i,redirect:s}=t[1];return e(Xi(i)),xe(s);case"auth/signout":return e(qi()),xe(this._redirectForLogin);case"auth/redirect":return xe(this._redirectForLogin,{next:window.location.href});default:const r=t[0];throw new Error(`Unhandled Auth message "${r}"`)}}};qs.EVENT_TYPE="auth:message";let Bs=qs;const Ws=Xs(Bs.EVENT_TYPE);function xe(n,t={}){if(!n)return;const e=window.location.href,i=new URL(n,e);return Object.entries(t).forEach(([s,r])=>i.searchParams.set(s,r)),()=>{console.log("Redirecting to ",n),window.location.assign(i)}}class Fi extends Ue{get redirect(){return this.getAttribute("redirect")||void 0}constructor(){super({user:mt.authenticateFromLocalStorage()})}connectedCallback(){new Bs(this.context,this.redirect).attach(this)}}class ft{constructor(){this.authenticated=!1,this.username="anonymous"}static deauthenticate(t){return t.authenticated=!1,t.username="anonymous",localStorage.removeItem(ze),t}}class mt extends ft{constructor(t){super();const e=Hs(t);console.log("Token payload",e),this.token=t,this.authenticated=!0,this.username=e.username}static authenticate(t){const e=new mt(t);return localStorage.setItem(ze,t),e}static authenticateFromLocalStorage(){const t=localStorage.getItem(ze);return t?mt.authenticate(t):new ft}}function Xi(n){return Hi({user:mt.authenticate(n),token:n})}function qi(){return n=>{const t=n.user;return{user:t&&t.authenticated?ft.deauthenticate(t):t,token:""}}}function Yi(n){return n.authenticated?{Authorization:`Bearer ${n.token||"NO_TOKEN"}`}:{}}function Bi(n){return n.authenticated?Hs(n.token||""):{}}const E=Object.freeze(Object.defineProperty({__proto__:null,AuthenticatedUser:mt,Provider:Fi,User:ft,dispatch:Ws,headers:Yi,payload:Bi},Symbol.toStringTag,{value:"Module"}));function ie(n,t,e){const i=n.target,s=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});console.log(`Relaying event from ${n.type}:`,s),i.dispatchEvent(s),n.stopPropagation()}function Oe(n,t="*"){return n.composedPath().find(i=>{const s=i;return s.tagName&&s.matches(t)})}const Wt=Object.freeze(Object.defineProperty({__proto__:null,originalTarget:Oe,relay:ie},Symbol.toStringTag,{value:"Module"})),Wi=new DOMParser;function Jt(n,...t){const e=n.map((o,a)=>a?[t[a-1],o]:[o]).flat().join(""),i=Wi.parseFromString(e,"text/html"),s=i.head.childElementCount?i.head.children:i.body.children,r=new DocumentFragment;return r.replaceChildren(...s),r}function me(n){const t=n.firstElementChild,e=t&&t.tagName==="TEMPLATE"?t:void 0;return{attach:i};function i(s,r={mode:"open"}){const o=s.attachShadow(r);return e&&o.appendChild(e.content.cloneNode(!0)),o}}const Js=class Vs extends HTMLElement{constructor(){super(),this._state={},me(Vs.template).attach(this),this.addEventListener("change",t=>{const e=t.target;if(e){const i=e.name,s=e.value;i&&(this._state[i]=s)}}),this.form&&this.form.addEventListener("submit",t=>{t.preventDefault(),ie(t,"mu-form:submit",this._state)})}set init(t){this._state=t||{},Vi(this._state,this)}get form(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("form")}};Js.template=Jt`
    <template>
...
`+this.showPosition(),{text:"",token:null,line:this.yylineno})},lex:function(){var d=this.next();return d||this.lex()},begin:function(d){this.conditionStack.push(d)},popState:function(){var d=this.conditionStack.length-1;return d>0?this.conditionStack.pop():this.conditionStack[0]},_currentRules:function(){return this.conditionStack.length&&this.conditionStack[this.conditionStack.length-1]?this.conditions[this.conditionStack[this.conditionStack.length-1]].rules:this.conditions.INITIAL.rules},topState:function(d){return d=this.conditionStack.length-1-Math.abs(d||0),d>=0?this.conditionStack[d]:"INITIAL"},pushState:function(d){this.begin(d)},stateStackSize:function(){return this.conditionStack.length},options:{},performAction:function(d,p,b,_){switch(b){case 0:return"(";case 1:return")";case 2:return"SPLAT";case 3:return"PARAM";case 4:return"LITERAL";case 5:return"LITERAL";case 6:return"EOF"}},rules:[/^(?:\()/,/^(?:\))/,/^(?:\*+\w+)/,/^(?::+\w+)/,/^(?:[\w%\-~\n]+)/,/^(?:.)/,/^(?:$)/],conditions:{INITIAL:{rules:[0,1,2,3,4,5,6],inclusive:!0}}};return h}();l.lexer=f;function m(){this.yy={}}return m.prototype=l,l.Parser=m,new m}();typeof Pn<"u"&&(n.parser=t,n.Parser=t.Parser,n.parse=function(){return t.parse.apply(t,arguments)})})(ui);function dt(n){return function(t,e){return{displayName:n,props:t,children:e||[]}}}var fi={Root:dt("Root"),Concat:dt("Concat"),Literal:dt("Literal"),Splat:dt("Splat"),Param:dt("Param"),Optional:dt("Optional")},mi=ui.parser;mi.yy=fi;var Cn=mi,zn=Object.keys(fi);function On(n){return zn.forEach(function(t){if(typeof n[t]>"u")throw new Error("No handler defined for "+t.displayName)}),{visit:function(t,e){return this.handlers[t.displayName].call(this,t,e)},handlers:n}}var gi=On,Tn=gi,Rn=/[\-{}\[\]+?.,\\\^$|#\s]/g;function vi(n){this.captures=n.captures,this.re=n.re}vi.prototype.match=function(n){var t=this.re.exec(n),e={};if(t)return this.captures.forEach(function(i,s){typeof t[s+1]>"u"?e[i]=void 0:e[i]=decodeURIComponent(t[s+1])}),e};var In=Tn({Concat:function(n){return n.children.reduce((function(t,e){var i=this.visit(e);return{re:t.re+i.re,captures:t.captures.concat(i.captures)}}).bind(this),{re:"",captures:[]})},Literal:function(n){return{re:n.props.value.replace(Rn,"\\$&"),captures:[]}},Splat:function(n){return{re:"([^?]*?)",captures:[n.props.name]}},Param:function(n){return{re:"([^\\/\\?]+)",captures:[n.props.name]}},Optional:function(n){var t=this.visit(n.children[0]);return{re:"(?:"+t.re+")?",captures:t.captures}},Root:function(n){var t=this.visit(n.children[0]);return new vi({re:new RegExp("^"+t.re+"(?=\\?|$)"),captures:t.captures})}}),Mn=In,Un=gi,jn=Un({Concat:function(n,t){var e=n.children.map((function(i){return this.visit(i,t)}).bind(this));return e.some(function(i){return i===!1})?!1:e.join("")},Literal:function(n){return decodeURI(n.props.value)},Splat:function(n,t){return t[n.props.name]?t[n.props.name]:!1},Param:function(n,t){return t[n.props.name]?t[n.props.name]:!1},Optional:function(n,t){var e=this.visit(n.children[0],t);return e||""},Root:function(n,t){t=t||{};var e=this.visit(n.children[0],t);return e?encodeURI(e):!1}}),Nn=jn,Ln=Cn,Dn=Mn,Hn=Nn;Vt.prototype=Object.create(null);Vt.prototype.match=function(n){var t=Dn.visit(this.ast),e=t.match(n);return e||!1};Vt.prototype.reverse=function(n){return Hn.visit(this.ast,n)};function Vt(n){var t;if(this?t=this:t=Object.create(Vt.prototype),typeof n>"u")throw new Error("A route spec is required");return t.spec=n,t.ast=Ln.parse(n),t}var Fn=Vt,Xn=Fn,qn=Xn;const Yn=En(qn);var Bn=Object.defineProperty,bi=(n,t,e,i)=>{for(var s=void 0,r=n.length-1,o;r>=0;r--)(o=n[r])&&(s=o(t,e,s)||s);return s&&Bn(t,e,s),s};class Nt extends ut{constructor(t,e,i=""){super(),this._cases=[],this._fallback=()=>Ct`
    ...
    `}updated(t){t.has("_match")&&this.requestUpdate()}matchRoute(t){const{search:e,pathname:i}=t,s=new URLSearchParams(e),r=i+e;for(const o of this._cases){const a=o.route.match(r);if(a)return{...o,path:i,params:a,query:s}}}redirect(t){Le(this,"history/redirect",{href:t})}}Nt.styles=on`
    :host,
    main {
      display: contents;
    }
  ...
  `;const yi=class $i extends HTMLElement{constructor(){super(),this._array=[],me($i.template).attach(this),this.addEventListener("input-array:add",t=>{t.stopPropagation(),this.append(xi("",this._array.length))}),this.addEventListener("input-array:remove",t=>{t.stopPropagation(),this.removeClosestItem(t.target)}),this.addEventListener("change",t=>{t.stopPropagation();const e=t.target;if(e&&e!==this){const i=new Event("change",{bubbles:!0}),s=e.value,r=e.closest("label");if(r){const o=Array.from(this.children).indexOf(r);this._array[o]=s,this.dispatchEvent(i)}}}),this.addEventListener("click",t=>{Oe(t,"button.add")?ie(t,"input-array:add"):Oe(t,"button.remove")&&ie(t,"input-array:remove")})}get name(){return this.getAttribute("name")}get value(){return this._array}set value(t){this._array=Array.isArray(t)?t:[t],Gn(this._array,this)}removeClosestItem(t){const e=t.closest("label");if(console.log("Removing closest item:",e,t),e){const i=Array.from(this.children).indexOf(e);this._array.splice(i,1),e.remove()}}};yi.template=Jt`
    <template>
      <ul>
        <slot></slot>
      </ul>
 ...
 */function v(n){return I({...n,state:!0,attribute:!1})}var Wr=Object.defineProperty,Ci=(n,t,e,i)=>{for(var s=void 0,r=n.length-1,o;r>=0;r--)(o=n[r])&&(s=o(t,e,s)||s);return s&&Wr(t,e,s),s};const Ke=class Ke extends F{constructor(){super(...arguments),this.display_name="Status: 401",this.curr_href=window.location.href,this._authObserver=new et(this,"acorn:auth"),this._historyObserver=new et(this,"acorn:history")}displayNameTemplate(){return this.display_name==="Status: 401"||this.display_name==="Status: 403"?u`
  ...
  `;let Ft=Ke;Ci([I({attribute:!1})],Ft.prototype,"display_name");Ci([I()],Ft.prototype,"curr_href");function Ns(n){Wt.relay(n,"auth:message",["auth/signout"])}ot({"restful-form":He.FormElement});class Jr extends F{render(){return u`
      <restful-form new src="/auth/login">
        <slot></slot>
      </restful-form>
    `}get next(){return new URLSearchParams(document.location.search).get("next")}constructor(){super(),this.addEventListener("mu-rest-form:created",t=>{const e=t.detail,{token:i}={token:e.created.session.access_token},s=this.next||"/";console.log("Login successful",e,s),Wt.relay(t,"auth:message",["auth/signin",{token:i,redirect:s}])})}}ot({"restful-form":He.FormElement});class Vr extends F{render(){return u`
...
`;var Gr={exports:{}};(function(n,t){(function(e,i,s,r,o){if("customElements"in s)o();else{if(s.AWAITING_WEB_COMPONENTS_POLYFILL)return void s.AWAITING_WEB_COMPONENTS_POLYFILL.then(o);var a=s.AWAITING_WEB_COMPONENTS_POLYFILL=m();a.then(o);var l=s.WEB_COMPONENTS_POLYFILL||"//cdnjs.cloudflare.com/ajax/libs/webcomponentsjs/2.0.2/webcomponents-bundle.js",f=s.ES6_CORE_POLYFILL||"//cdnjs.cloudflare.com/ajax/libs/core-js/2.5.3/core.min.js";"Promise"in s?h(l).then(function(){a.isDone=!0,a.exec()}):h(f).then(function(){h(l).then(function(){a.isDone=!0,a.exec()})})}function m(){var c=[];return c.isDone=!1,c.exec=function(){c.splice(0).forEach(function(d){d()})},c.then=function(d){return c.isDone?d():c.push(d),c},c}function h(c){var d=m(),p=r.createElement("script");return p.type="text/javascript",p.readyState?p.onreadystatechange=function(){p.readyState!="loaded"&&p.readyState!="complete"||(p.onreadystatechange=null,d.isDone=!0,d.exec())}:p.onload=function(){d.isDone=!0,d.exec()},p.src=c,r.getElementsByTagName("head")[0].appendChild(p),p.then=d.then,p}})(0,0,window,document,function(){var e;e=function(){return function(i){var s={};function r(o){if(s[o])return s[o].exports;var a=s[o]={i:o,l:!1,exports:{}};return i[o].call(a.exports,a,a.exports,r),a.l=!0,a.exports}return r.m=i,r.c=s,r.d=function(o,a,l){r.o(o,a)||Object.defineProperty(o,a,{enumerable:!0,get:l})},r.r=function(o){typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(o,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(o,"__esModule",{value:!0})},r.t=function(o,a){if(1&a&&(o=r(o)),8&a||4&a&&typeof o=="object"&&o&&o.__esModule)return o;var l=Object.create(null);if(r.r(l),Object.defineProperty(l,"default",{enumerable:!0,value:o}),2&a&&typeof o!="string")for(var f in o)r.d(l,f,(function(m){return o[m]}).bind(null,f));return l},r.n=function(o){var a=o&&o.__esModule?function(){return o.default}:function(){return o};return r.d(a,"a",a),a},r.o=function(o,a){return Object.prototype.hasOwnProperty.call(o,a)},r.p="",r(r.s=5)}([function(i,s){i.exports=function(r){var o=[];return o.toString=function(){return this.map(function(a){var l=function(f,m){var h,c=f[1]||"",d=f[3];if(!d)return c;if(m&&typeof btoa=="function"){var p=(h=d,"/*# sourceMappingURL=data:application/json;charset=utf-8;base64,"+btoa(unescape(encodeURIComponent(JSON.stringify(h))))+" */"),b=d.sources.map(function(_){return"/*# sourceURL="+d.sourceRoot+_+" */"});return[c].concat(b).concat([p]).join(`
`)}return[c].join(`
`)}(a,r);return a[2]?"@media "+a[2]+"{"+l+"}":l}).join("")},o.i=function(a,l){typeof a=="string"&&(a=[[null,a,""]]);for(var f={},m=0;m<this.length;m++){var h=this[m][0];typeof h=="number"&&(f[h]=!0)}for(m=0;m<a.length;m++){var c=a[m];typeof c[0]=="number"&&f[c[0]]||(l&&!c[2]?c[2]=l:l&&(c[2]="("+c[2]+") and ("+l+")"),o.push(c))}},o}},function(i,s,r){var o=r(3);i.exports=typeof o=="string"?o:o.toString()},function(i,s,r){var o=r(4);i.exports=typeof o=="string"?o:o.toString()},function(i,s,r){(i.exports=r(0)(!1)).push([i.i,"@-webkit-keyframes spin{0%{-webkit-transform:rotate(0);transform:rotate(0)}to{-webkit-transform:rotate(359deg);transform:rotate(359deg)}}@keyframes spin{0%{-webkit-transform:rotate(0);transform:rotate(0)}to{-webkit-transform:rotate(359deg);transform:rotate(359deg)}}@-webkit-keyframes burst{0%{-webkit-transform:scale(1);transform:scale(1);opacity:1}90%{-webkit-transform:scale(1.5);transform:scale(1.5);opacity:0}}@keyframes burst{0%{-webkit-transform:scale(1);transform:scale(1);opacity:1}90%{-webkit-transform:scale(1.5);transform:scale(1.5);opacity:0}}@-webkit-keyframes flashing{0%{opacity:1}45%{opacity:0}90%{opacity:1}}@keyframes flashing{0%{opacity:1}45%{opacity:0}90%{opacity:1}}@-webkit-keyframes fade-left{0%{-webkit-transform:translateX(0);transform:translateX(0);opacity:1}75%{-webkit-transform:translateX(-20px);transform:translateX(-20px);opacity:0}}@keyframes fade-left{0%{-webkit-transform:translateX(0);transform:translateX(0);opacity:1}75%{-webkit-transform:translateX(-20px);transform:translateX(-20px);opacity:0}}@-webkit-keyframes fade-right{0%{-webkit-transform:translateX(0);transform:translateX(0);opacity:1}75%{-webkit-transform:translateX(20px);transform:translateX(20px);opacity:0}}@keyframes fade-right{0%{-webkit-transform:translateX(0);transform:translateX(0);opacity:1}75%{-webkit-transform:translateX(20px);transform:translateX(20px);opacity:0}}@-webkit-keyframes fade-up{0%{-webkit-transform:translateY(0);transform:translateY(0);opacity:1}75%{-webkit-transform:translateY(-20px);transform:translateY(-20px);opacity:0}}@keyframes fade-up{0%{-webkit-transform:translateY(0);transform:translateY(0);opacity:1}75%{-webkit-transform:translateY(-20px);transform:translateY(-20px);opacity:0}}@-webkit-keyframes fade-down{0%{-webkit-transform:translateY(0);transform:translateY(0);opacity:1}75%{-webkit-transform:translateY(20px);transform:translateY(20px);opacity:0}}@keyframes fade-down{0%{-webkit-transform:translateY(0);transform:translateY(0);opacity:1}75%{-webkit-transform:translateY(20px);transform:translateY(20px);opacity:0}}@-webkit-keyframes tada{0%{-webkit-transform:scaleX(1);transform:scaleX(1)}10%,20%{-webkit-transform:scale3d(.95,.95,.95) rotate(-10deg);transform:scale3d(.95,.95,.95) rotate(-10deg)}30%,50%,70%,90%{-webkit-transform:scaleX(1) rotate(10deg);transform:scaleX(1) rotate(10deg)}40%,60%,80%{-webkit-transform:scaleX(1) rotate(-10deg);transform:scaleX(1) rotate(-10deg)}to{-webkit-transform:scaleX(1);transform:scaleX(1)}}@keyframes tada{0%{-webkit-transform:scaleX(1);transform:scaleX(1)}10%,20%{-webkit-transform:scale3d(.95,.95,.95) rotate(-10deg);transform:scale3d(.95,.95,.95) rotate(-10deg)}30%,50%,70%,90%{-webkit-transform:scaleX(1) rotate(10deg);transform:scaleX(1) rotate(10deg)}40%,60%,80%{-webkit-transform:rotate(-10deg);transform:rotate(-10deg)}to{-webkit-transform:scaleX(1);transform:scaleX(1)}}.bx-spin,.bx-spin-hover:hover{-webkit-animation:spin 2s linear infinite;animation:spin 2s linear infinite}.bx-tada,.bx-tada-hover:hover{-webkit-animation:tada 1.5s ease infinite;animation:tada 1.5s ease infinite}.bx-flashing,.bx-flashing-hover:hover{-webkit-animation:flashing 1.5s infinite linear;animation:flashing 1.5s infinite linear}.bx-burst,.bx-burst-hover:hover{-webkit-animation:burst 1.5s infinite linear;animation:burst 1.5s infinite linear}.bx-fade-up,.bx-fade-up-hover:hover{-webkit-animation:fade-up 1.5s infinite linear;animation:fade-up 1.5s infinite linear}.bx-fade-down,.bx-fade-down-hover:hover{-webkit-animation:fade-down 1.5s infinite linear;animation:fade-down 1.5s infinite linear}.bx-fade-left,.bx-fade-left-hover:hover{-webkit-animation:fade-left 1.5s infinite linear;animation:fade-left 1.5s infinite linear}.bx-fade-right,.bx-fade-right-hover:hover{-webkit-animation:fade-right 1.5s infinite linear;animation:fade-right 1.5s infinite linear}",""])},function(i,s,r){(i.exports=r(0)(!1)).push([i.i,'.bx-rotate-90{transform:rotate(90deg);-ms-filter:"progid:DXImageTransform.Microsoft.BasicImage(rotation=1)"}.bx-rotate-180{transform:rotate(180deg);-ms-filter:"progid:DXImageTransform.Microsoft.BasicImage(rotation=2)"}.bx-rotate-270{transform:rotate(270deg);-ms-filter:"progid:DXImageTransform.Microsoft.BasicImage(rotation=3)"}.bx-flip-horizontal{transform:scaleX(-1);-ms-filter:"progid:DXImageTransform.Microsoft.BasicImage(rotation=0, mirror=1)"}.bx-flip-vertical{transform:scaleY(-1);-ms-filter:"progid:DXImageTransform.Microsoft.BasicImage(rotation=2, mirror=1)"}',""])},function(i,s,r){r.r(s),r.d(s,"BoxIconElement",function(){return At});var o,a,l,f,m=r(1),h=r.n(m),c=r(2),d=r.n(c),p=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(S){return typeof S}:function(S){return S&&typeof Symbol=="function"&&S.constructor===Symbol&&S!==Symbol.prototype?"symbol":typeof S},b=function(){function S(A,g){for(var y=0;y<g.length;y++){var $=g[y];$.enumerable=$.enumerable||!1,$.configurable=!0,"value"in $&&($.writable=!0),Object.defineProperty(A,$.key,$)}}return function(A,g,y){return g&&S(A.prototype,g),y&&S(A,y),A}}(),_=(a=(o=Object).getPrototypeOf||function(S){return S.__proto__},l=o.setPrototypeOf||function(S,A){return S.__proto__=A,S},f=(typeof Reflect>"u"?"undefined":p(Reflect))==="object"?Reflect.construct:function(S,A,g){var y,$=[null];return $.push.apply($,A),y=S.bind.apply(S,$),l(new y,g.prototype)},function(S){var A=a(S);return l(S,l(function(){return f(A,arguments,a(this).constructor)},A))}),k=window,G={},T=document.createElement("template"),at=function(){return!!k.ShadyCSS};T.innerHTML=`
<style>
:host {
...
`+P)})})(this,0,$);break;case"color":j.style.fill=$||"";break;case"size":(function(N,X,w){var x=N._state;x.size&&(x.$iconHolder.style.width=x.$iconHolder.style.height="",x.size=x.sizeType=null),w&&!/^(xs|sm|md|lg)$/.test(x.size)&&(x.size=w.trim(),x.$iconHolder.style.width=x.$iconHolder.style.height=x.size)})(this,0,$);break;case"rotate":y&&j.classList.remove("bx-rotate-"+y),$&&j.classList.add("bx-rotate-"+$);break;case"flip":y&&j.classList.remove("bx-flip-"+y),$&&j.classList.add("bx-flip-"+$);break;case"animation":y&&j.classList.remove("bx-"+y),$&&j.classList.add("bx-"+$)}}},{key:"connectedCallback",value:function(){at()&&k.ShadyCSS.styleElement(this)}}]),A}());s.default=At,At.define()}])},n.exports=e()})})(Gr);const Qe=class Qe extends D{constructor(){super("acorn:model")}render(){return u`
    ...
    `}};Qe.styles=[M,U,C`
        ...
        `];let Ie=Qe;function Pe(n){Wt.relay(n,"auth:message",["auth/signout"])}var Zr=Object.defineProperty,Kr=Object.getOwnPropertyDescriptor,Ve=(n,t,e,i)=>{for(var s=i>1?void 0:i?Kr(t,e):t,r=n.length-1,o;r>=0;r--)(o=n[r])&&(s=(i?o(t,e,s):o(s))||s);return i&&s&&Zr(t,e,s),s};const Qr=[{id:1,label:"Active"},{id:2,label:"Inactive"},{id:3,label:"Unverified"}],ts=class ts extends D{constructor(){super("acorn:model"),this.filter_status_ids=[1,3]}get staff(){return this.model.staff}get showing_total(){return this.staff?this.staff.length:0}connectedCallback(){super.connectedCallback(),this.updateStaff()}updateStaff(){this.dispatchMessage(["staff/",{filter_status_ids:this.filter_status_ids}])}handleTableOptionChange(t){this.handleInputChange(t),this.updateStaff()}handleInputChange(t){const e=t.target,{name:i,value:s,type:r}=e;r==="checkbox"?this.handleCheckboxChange(t):this[i]=s}handleCheckboxChange(t){const e=t.target,{name:i}=e,s=i,r=parseInt(e.value);switch(s){case"staff_status":e.checked?this.filter_status_ids=[...this.filter_status_ids,r]:this.filter_status_ids=this.filter_status_ids.filter(a=>a!==r);break;default:const o=s;throw new Error(`Unhandled Auth message "${o}"`)}}render(){const t=(s,r)=>{var o;switch(r){case"staff_status":o=this.filter_status_ids;break;default:const a=r;throw new Error(`Unhandled Auth message "${a}"`)}return u`
            <label>
            <input
                name=${r}
                type="checkbox"
    ...
    `}};ss.styles=[M,U,C`
        ...
        `];let Xt=ss;zi([v()],Xt.prototype,"roles");zi([v()],Xt.prototype,"showing_total");var oo=Object.defineProperty,ao=Object.getOwnPropertyDescriptor,Ge=(n,t,e,i)=>{for(var s=i>1?void 0:i?ao(t,e):t,r=n.length-1,o;r>=0;r--)(o=n[r])&&(s=(i?o(t,e,s):o(s))||s);return i&&s&&oo(t,e,s),s};const lo=[{id:1,label:"Active"},{id:2,label:"Inactive"}];function co(n){const t=Math.floor(n/60),e=n%60;return!t&&!n?u`<box-icon name='error' color="var(--accent-color-red)"></box-icon>`:t?e&&t===1?`${t} Hour ${e} Minutes`:e?`${t} Hours ${e} Minutes`:t===1?`${t} Hour`:`${t} Hours`:`${e} Minutes`}const is=class is extends D{constructor(){super("acorn:model"),this.filter_status_ids=[1]}get properties(){return this.model.properties}get showing_total(){return this.properties?this.properties.length:0}connectedCallback(){super.connectedCallback(),this.updateProperties()}updateProperties(){this.dispatchMessage(["properties/",{filter_status_ids:this.filter_status_ids}])}handleTableOptionChange(t){this.handleInputChange(t),this.updateProperties()}handleInputChange(t){const e=t.target,{name:i,value:s,type:r}=e;r==="checkbox"?this.handleCheckboxChange(t):this[i]=s}handleCheckboxChange(t){const e=t.target,{name:i}=e,s=i,r=parseInt(e.value);switch(s){case"property_status":e.checked?this.filter_status_ids=[...this.filter_status_ids,r]:this.filter_status_ids=this.filter_status_ids.filter(a=>a!==r);break;default:const o=s;throw new Error(`Unhandled Auth message "${o}"`)}}render(){const t=(r,o)=>{var a;switch(o){case"property_status":a=this.filter_status_ids;break;default:const l=o;throw new Error(`Unhandled Auth message "${l}"`)}return u`
            <label>
            <input
                name=${o}
                type="checkbox"
    ...
    `}};is.styles=[M,U,C`
        ...
        `];let xt=is;Ge([v()],xt.prototype,"properties",1);Ge([v()],xt.prototype,"showing_total",1);Ge([v()],xt.prototype,"filter_status_ids",2);var ho=Object.defineProperty,po=Object.getOwnPropertyDescriptor,be=(n,t,e,i)=>{for(var s=i>1?void 0:i?po(t,e):t,r=n.length-1,o;r>=0;r--)(o=n[r])&&(s=(i?o(t,e,s):o(s))||s);return i&&s&&ho(t,e,s),s};const ns=class ns extends D{get staff(){return this.model.staff}get staff_options(){return this.staff&&this.plan&&this.plan.staff?this.staff.filter(t=>!this.plan.staff.map(e=>e.staff_info.user_id).includes(t.user_id)).map(t=>({id:t.user_id,label:t.name})):this.staff?this.staff.map(t=>({id:t.user_id,label:t.name})):[]}constructor(){super("acorn:model")}handleInputChange(t){const e=t.target,{name:i,value:s}=e;this[i]=s}addPlanStaff(){this.plan&&this.staff_to_add&&this.dispatchMessage(["plans/staff/add",{plan_id:this.plan.plan_id,user_id:this.staff_to_add}]),this.closeDialog()}closeDialog(){this.shadowRoot.querySelector("dialog").close()}showModal(){this.shadowRoot.querySelector("dialog").showModal()}render(){const t=e=>u`
    ...
    `}};rs.styles=[M,U,C`
        ...
        `];let rt=rs;_e([v()],rt.prototype,"appointments",1);_e([I({attribute:!1})],rt.prototype,"plan",2);_e([v()],rt.prototype,"appointment_options",1);_e([v()],rt.prototype,"app_to_add",2);var mo=Object.defineProperty,go=Object.getOwnPropertyDescriptor,Oi=(n,t,e,i)=>{for(var s=i>1?void 0:i?go(t,e):t,r=n.length-1,o;r>=0;r--)(o=n[r])&&(s=(i?o(t,e,s):o(s))||s);return i&&s&&mo(t,e,s),s};const he=class he extends D{get model_plan(){return this.model.plan}constructor(){super("acorn:model")}updated(t){super.updated(t);var e=this.model_plan;e&&(!this.plan||e.plan_id===this.plan.plan_id)&&(this.plan=e)}handleStaffRemove(t){const e=t.target,{name:i}=e;i!==void 0&&this.dispatchMessage(["plans/staff/remove",{plan_id:this.plan.plan_id,user_id:parseInt(i)}])}handleAppointmentRemove(t){const e=t.target,{name:i}=e;i!==void 0&&this.dispatchMessage(["plans/appointment/remove",{plan_id:this.plan.plan_id,appointment_id:parseInt(i)}])}render(){if(!this.plan)return u`<section><p>Loading...</p></section>`;const t=i=>{var s,r;return u`
            <li>
                <span>${i.name}</span>
    ...
    `}};he.uses=ot({"add-staff-modal":nt,"add-appointment-modal":rt}),he.styles=[M,U,C`
            section {
                background-color: var(--background-color-accent);
                border-radius: var(--border-size-radius);
                padding: var(--spacing-size-small) var(--spacing-size-medium);
    ...
    `}};as.styles=[M,U,C`
        ...
        `];let V=as;Kt([I({attribute:!1})],V.prototype,"services",2);Kt([I()],V.prototype,"date",2);Kt([v()],V.prototype,"appointments",1);Kt([v()],V.prototype,"appointment_omissions",2);Kt([v()],V.prototype,"appointment_options",1);var $o=Object.defineProperty,Ti=(n,t,e,i)=>{for(var s=void 0,r=n.length-1,o;r>=0;r--)(o=n[r])&&(s=o(t,e,s)||s);return s&&$o(t,e,s),s};const ls=class ls extends F{attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="code"&&e!==i&&i&&(i.split(":")[0]==="no-error"?this.requestPlanUpdate():this.show())}requestPlanUpdate(){const t=new CustomEvent("build-error-dialog:no-error",{bubbles:!0,composed:!0,detail:{}});this.dispatchEvent(t)}closeDialog(){this.shadowRoot.querySelector("dialog").close()}show(){this.shadowRoot.querySelector("dialog").show()}render(){const t=i=>i?u`
    ...
    `}};ls.styles=[M,U,C`
        ...
        `];let Yt=ls;Ti([I({attribute:!1})],Yt.prototype,"error");Ti([I()],Yt.prototype,"code");var xo=Object.defineProperty,wo=(n,t,e,i)=>{for(var s=void 0,r=n.length-1,o;r>=0;r--)(o=n[r])&&(s=o(t,e,s)||s);return s&&xo(t,e,s),s};const cs=class cs extends F{closeDialog(){this.shadowRoot.querySelector("dialog").close()}show(){console.log("Showing Info ***"),this.shadowRoot.querySelector("dialog").show()}render(){return u`
        <div>
            <button @click=${this.show}>
    ...
    `}};cs.styles=[M,U,C`
        ...
        `];let ce=cs;wo([I()],ce.prototype,"name");var ko=Object.defineProperty,So=Object.getOwnPropertyDescriptor,H=(n,t,e,i)=>{for(var s=i>1?void 0:i?So(t,e):t,r=n.length-1,o;r>=0;r--)(o=n[r])&&(s=(i?o(t,e,s):o(s))||s);return i&&s&&ko(t,e,s),s};const pe=class pe extends D{constructor(){super("acorn:model"),this.build_count=0,this.from_plan_date=Me(new Date).split("T")[0],this.per_page=10,this.page=1,this.filter_service_ids=[21942,23044],this.routing_type=1,this.cleaning_window=6,this.max_hours=8,this.addEventListener("build-error-dialog:no-error",()=>{this.updatePlans()})}get plans(){return this.model.plans}get services(){return this.model.services}get build_error(){return this.model.build_error}get showing_total(){return this.plans?this.plans.length:0}get service_options(){return this.services?this.services.map(t=>({id:t.service_id,label:t.service_name})):[]}connectedCallback(){super.connectedCallback(),this.dispatchMessage(["services/",{}]),this.updatePlans()}updatePlans(){this.dispatchMessage(["plans/",{from_plan_date:this.from_plan_date,per_page:this.per_page,page:this.page-1}])}buildSchedule(){this.build_count++,this.dispatchMessage(["plans/build",{plan_date:this.from_plan_date,build_options:{available_staff:this.model.available?this.model.available:[],services:this.filter_service_ids,omissions:this.model.omissions?this.model.omissions:[],routing_type:this.routing_type,cleaning_window:this.cleaning_window,max_hours:this.max_hours,target_staff_count:this.target_staff_count}}])}copySchedule(){this.build_count++,this.dispatchMessage(["plans/copy",{plan_date:this.from_plan_date}])}sendSchedule(){this.build_count++,this.dispatchMessage(["plans/send",{plan_date:this.from_plan_date}]),this.closeSendModal()}addPlan(){this.build_count++,this.dispatchMessage(["plans/add",{plan_date:this.from_plan_date}])}handleTableOptionChange(t){this.handleInputChange(t);const e=t.target,{name:i}=e;(i==="per_page"||i==="from_plan_date")&&this.updatePlans()}handleInputChange(t){const e=t.target,{name:i,value:s,type:r}=e;r==="checkbox"?this.handleCheckboxChange(t):this[i]=s}handleCheckboxChange(t){const e=t.target,{name:i}=e,s=i,r=parseInt(e.value);switch(s){case"app_service":e.checked?this.filter_service_ids=[...this.filter_service_ids,r]:this.filter_service_ids=this.filter_service_ids.filter(a=>a!==r);break;default:const o=s;throw new Error(`Unhandled Auth message "${o}"`)}}previousPage(){this.page>1&&(this.page--,this.updatePlans())}nextPage(){this.page++,this.updatePlans()}closeSendModal(){this.shadowRoot.querySelector("dialog.send-modal").close()}showSendModal(){this.shadowRoot.querySelector("dialog.send-modal").showModal()}render(){const t=(s,r)=>{var o;switch(r){case"app_service":o=this.filter_service_ids;break;default:const a=r;throw new Error(`Unhandled Auth message "${a}"`)}return u`
            <label>
            <input
                name=${r}
                type="checkbox"
    ...
    `}};pe.uses=ot({"plan-view":qt,"available-modal":wt,"omissions-modal":V,"build-error-dialog":Yt,"info-dialog":ce}),pe.styles=[M,U,C`
...
`,ds=class ds extends F{render(){return u`
    <div class="page">
        <header>
            <h1>
    ...
    `];let de=ds;St([I()],de.prototype,"property",2);const ue=class ue extends F{render(){return u`
    <div class="page">
        <header>
            <h1>
                <slot name="property_name_header"><span>Property View</span></slot>
    ...
    `}};ue.uses=ot({"mu-form":Gi.Element,"input-array":Zn.Element}),ue.styles=[M,U,Ri,C`
        mu-form {
        grid-column: key / end;
        }
        mu-form input {
    ...
    `];let Bt=ue;St([I()],Bt.prototype,"property",2);St([I({attribute:!1})],Bt.prototype,"init",2);const fe=class fe extends D{constructor(){super("acorn:model"),this.edit=!1,this.properties_id=0}get property(){return this.model.property}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="properties-id"&&e!==i&&i&&(console.log("Property Page:",i),this.dispatchMessage(["properties/select",{properties_id:parseInt(i)}]))}render(){const{properties_id:t,property_name:e,address:i,status:s,estimated_cleaning_mins:r,double_unit:o=[]}=this.property||{properties_id:0},a=o.map(f=>u`
        <li>${f}</li>
        `),l=u`
    ...
    `];let kt=fe;St([I({type:Boolean,reflect:!0})],kt.prototype,"edit",2);St([I({attribute:"properties-id",reflect:!0,type:Number})],kt.prototype,"properties_id",2);St([v()],kt.prototype,"property",1);const Po=[{path:"/app/appointments",view:()=>u`
    ...
    `},{path:"/",redirect:"/app"}];ot({"mu-auth":E.Provider,"mu-store":class extends nn.Provider{constructor(){super($r,yr,"acorn:auth")}},"mu-history":Ks.Provider,"mu-switch":class extends Wn.Element{constructor(){super(Po,"acorn:history","acorn:auth")}},"side-bar":Ft,"login-form":Jr,"signup-form":Vr,"restful-form":He.FormElement,"landing-view":Ie,"staff-view":$t,"appointments-view":L,"roles-view":Xt,"properties-view":xt,"plans-view":R,"property-view":kt});export{E as a,ot as d,Wt as e};
