 ...
 */function v(n){return U({...n,state:!0,attribute:!1})}var Wr=Object.defineProperty,Ci=(n,t,e,i)=>{for(var s=void 0,r=n.length-1,o;r>=0;r--)(o=n[r])&&(s=o(t,e,s)||s);return s&&Wr(t,e,s),s};const Ke=class Ke extends q{constructor(){super(...arguments),this.display_name="Status: 401",this.curr_href=window.location.href,this._authObserver=new et(this,"acorn:auth"),this._historyObserver=new et(this,"acorn:history")}displayNameTemplate(){return this.display_name==="Status: 401"||this.display_name==="Status: 403"?u`
  ...
  `;let qt=Ke;Ci([U({attribute:!1})],qt.prototype,"display_name");Ci([U()],qt.prototype,"curr_href");function Ns(n){Wt.relay(n,"auth:message",["auth/signout"])}ot({"restful-form":He.FormElement});class Jr extends q{render(){return u`
      <restful-form new src="/auth/login">
        <slot></slot>
      </restful-form>
    `}get next(){return new URLSearchParams(document.location.search).get("next")}constructor(){super(),this.addEventListener("mu-rest-form:created",t=>{const e=t.detail,{token:i}={token:e.created.session.access_token},s=this.next||"/";console.log("Login successful",e,s),Wt.relay(t,"auth:message",["auth/signin",{token:i,redirect:s}])})}}ot({"restful-form":He.FormElement});class Vr extends q{render(){return u`
...
`+P)})})(this,0,$);break;case"color":j.style.fill=$||"";break;case"size":(function(N,F,w){var x=N._state;x.size&&(x.$iconHolder.style.width=x.$iconHolder.style.height="",x.size=x.sizeType=null),w&&!/^(xs|sm|md|lg)$/.test(x.size)&&(x.size=w.trim(),x.$iconHolder.style.width=x.$iconHolder.style.height=x.size)})(this,0,$);break;case"rotate":y&&j.classList.remove("bx-rotate-"+y),$&&j.classList.add("bx-rotate-"+$);break;case"flip":y&&j.classList.remove("bx-flip-"+y),$&&j.classList.add("bx-flip-"+$);break;case"animation":y&&j.classList.remove("bx-"+y),$&&j.classList.add("bx-"+$)}}},{key:"connectedCallback",value:function(){at()&&k.ShadyCSS.styleElement(this)}}]),A}());s.default=At,At.define()}])},n.exports=e()})})(Gr);const Qe=class Qe extends D{constructor(){super("acorn:model")}render(){return u`
    ...
    `}};ts.styles=[I,M,C`
        ...
        `,i=r=>{var o,a;return u`
            <tr>
                ...
                <td class="center">
                    <ul class="staff">
                        ${r.staff&&r.staff.length>0?(o=r.staff)==null?void 0:o.map(l=>e(l.staff_info)):u`<box-icon name='error' color="var(--accent-color-red)"></box-icon>`}
                    </ul>
                </td>
                <td class="center">
                    <span>
    ...
    `}};rs.styles=[I,M,C`
        ...
        `];let rt=rs;_e([v()],rt.prototype,"appointments",1);_e([U({attribute:!1})],rt.prototype,"plan",2);_e([v()],rt.prototype,"appointment_options",1);_e([v()],rt.prototype,"app_to_add",2);var mo=Object.defineProperty,go=Object.getOwnPropertyDescriptor,Oi=(n,t,e,i)=>{for(var s=i>1?void 0:i?go(t,e):t,r=n.length-1,o;r>=0;r--)(o=n[r])&&(s=(i?o(t,e,s):o(s))||s);return i&&s&&mo(t,e,s),s};const he=class he extends D{get model_plan(){return this.model.plan}constructor(){super("acorn:model")}updated(t){super.updated(t);var e=this.model_plan;e&&(!this.plan||e.plan_id===this.plan.plan_id)&&(this.plan=e)}handleStaffRemove(t){const e=t.target,{name:i}=e;i!==void 0&&(this.dispatchMessage(["plans/staff/remove",{plan_id:this.plan.plan_id,user_id:parseInt(i)}]),this.requestPlanUpdate())}handleAppointmentRemove(t){const e=t.target,{name:i}=e;i!==void 0&&(this.dispatchMessage(["plans/appointment/remove",{plan_id:this.plan.plan_id,appointment_id:parseInt(i)}]),this.requestPlanUpdate())}requestPlanUpdate(){const t=new CustomEvent("plan-view:update",{bubbles:!0,composed:!0,detail:{}});this.dispatchEvent(t)}render(){if(!this.plan)return u`<section><p>Loading...</p></section>`;const t=i=>{var s,r;return u`
            <li>
                <span>${i.name}</span>
        ...
        <section>
            ...
            <ul> 
                ${this.plan.appointments.map(i=>i.appointment_info.status.status_id!==5?e(i.appointment_info):u``)}
                <add-appointment-modal .plan=${this.plan}></add-appointment-modal>
            </ul>
        </section>
    `}};he.uses=ot({"add-staff-modal":nt,"add-appointment-modal":rt}),he.styles=[I,M,C`
            section {
                background-color: var(--background-color-accent);
                border-radius: var(--border-size-radius);
                padding: var(--spacing-size-small) var(--spacing-size-medium);
    ...
    `}};as.styles=[I,M,C`
        ...
        `];let V=as;Kt([U({attribute:!0,reflect:!0})],V.prototype,"services",2);Kt([U()],V.prototype,"date",2);Kt([v()],V.prototype,"appointments",1);Kt([v()],V.prototype,"appointment_omissions",2);Kt([v()],V.prototype,"appointment_options",1);var $o=Object.defineProperty,Ti=(n,t,e,i)=>{for(var s=void 0,r=n.length-1,o;r>=0;r--)(o=n[r])&&(s=o(t,e,s)||s);return s&&$o(t,e,s),s};const ls=class ls extends q{attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="code"&&e!==i&&i&&(i.split(":")[0]==="no-error"?e.split(":")[1]!==i.split(":")[1]&&this.requestPlanUpdate():this.show())}requestPlanUpdate(){const t=new CustomEvent("build-error-dialog:no-error",{bubbles:!0,composed:!0,detail:{}});this.dispatchEvent(t)}closeDialog(){this.shadowRoot.querySelector("dialog").close()}show(){this.shadowRoot.querySelector("dialog").show()}render(){const t=i=>i?u`
    ...
    `}};ls.styles=[I,M,C`
        ...
        `];let Yt=ls;Ti([U({attribute:!1})],Yt.prototype,"error");Ti([U()],Yt.prototype,"code");var xo=Object.defineProperty,wo=(n,t,e,i)=>{for(var s=void 0,r=n.length-1,o;r>=0;r--)(o=n[r])&&(s=o(t,e,s)||s);return s&&xo(t,e,s),s};const cs=class cs extends q{closeDialog(){this.shadowRoot.querySelector("dialog").close()}show(){console.log("Showing Info ***"),this.shadowRoot.querySelector("dialog").show()}render(){return u`
        <div>
            <button @click=${this.show}>
    ...
    `}};cs.styles=[I,M,C`
        ...
        `];let ce=cs;wo([U()],ce.prototype,"name");var ko=Object.defineProperty,So=Object.getOwnPropertyDescriptor,H=(n,t,e,i)=>{for(var s=i>1?void 0:i?So(t,e):t,r=n.length-1,o;r>=0;r--)(o=n[r])&&(s=(i?o(t,e,s):o(s))||s);return i&&s&&ko(t,e,s),s};const pe=class pe extends D{constructor(){super("acorn:model"),this.build_count=0,this.from_plan_date=Ie(new Date).split("T")[0],this.per_page=10,this.page=1,this.filter_service_ids=[21942,23044],this.routing_type=1,this.cleaning_window=6,this.max_hours=8,this.addEventListener("build-error-dialog:no-error",()=>{this.updatePlans()}),this.addEventListener("plan-view:update",()=>{this.updatePlans()})}get plans(){return this.model.plans}get services(){return this.model.services}get build_error(){return this.model.build_error}get showing_total(){return this.plans?this.plans.length:0}get service_options(){return this.services?this.services.map(t=>({id:t.service_id,label:t.service_name})):[]}connectedCallback(){super.connectedCallback(),this.dispatchMessage(["services/",{}]),this.updatePlans()}updatePlans(){this.dispatchMessage(["plans/",{from_plan_date:this.from_plan_date,per_page:this.per_page,page:this.page-1}])}buildSchedule(){this.build_error&&this.dispatchMessage(["build_error/reset",{}]),this.dispatchMessage(["plans/build",{plan_date:this.from_plan_date,build_options:{available_staff:this.model.available?this.model.available:[],services:this.filter_service_ids,omissions:this.model.omissions?this.model.omissions:[],routing_type:this.routing_type,cleaning_window:this.cleaning_window,max_hours:this.max_hours,target_staff_count:this.target_staff_count}}]),this.build_count++}copySchedule(){this.dispatchMessage(["plans/copy",{plan_date:this.from_plan_date}]),this.build_count++}sendSchedule(){this.dispatchMessage(["plans/send",{plan_date:this.from_plan_date}]),this.build_count++,this.closeSendModal()}addPlan(){this.dispatchMessage(["plans/add",{plan_date:this.from_plan_date}]),this.build_count++}handleTableOptionChange(t){this.handleInputChange(t);const e=t.target,{name:i}=e;(i==="per_page"||i==="from_plan_date")&&this.updatePlans()}handleInputChange(t){const e=t.target,{name:i,value:s,type:r}=e;r==="checkbox"?this.handleCheckboxChange(t):this[i]=s}handleCheckboxChange(t){const e=t.target,{name:i}=e,s=i,r=parseInt(e.value);switch(s){case"app_service":e.checked?this.filter_service_ids=[...this.filter_service_ids,r]:this.filter_service_ids=this.filter_service_ids.filter(a=>a!==r);break;default:const o=s;throw new Error(`Unhandled Auth message "${o}"`)}}previousPage(){this.page>1&&(this.page--,this.updatePlans())}nextPage(){this.page++,this.updatePlans()}closeSendModal(){this.shadowRoot.querySelector("dialog.send-modal").close()}showSendModal(){this.shadowRoot.querySelector("dialog.send-modal").showModal()}render(){const t=(s,r)=>{var o;switch(r){case"app_service":o=this.filter_service_ids;break;default:const a=r;throw new Error(`Unhandled Auth message "${a}"`)}return u`
            <label>
            <input
                name=${r}
                type="checkbox"
    ...
    `}};pe.uses=ot({"plan-view":Xt,"available-modal":wt,"omissions-modal":V,"build-error-dialog":Yt,"info-dialog":ce}),pe.styles=[I,M,C`
...
`,ds=class ds extends q{render(){return u`
    ...
    `}};ue.uses=ot({"mu-form":Gi.Element,"input-array":Zn.Element}),ue.styles=[I,M,Ri,C`
        mu-form {
        grid-column: key / end;
        }
        mu-form input {
    ...
    `];let kt=fe;St([U({type:Boolean,reflect:!0})],kt.prototype,"edit",2);St([U({attribute:"properties-id",reflect:!0,type:Number})],kt.prototype,"properties_id",2);St([v()],kt.prototype,"property",1);const Po=[{path:"/app/appointments",view:()=>u`
