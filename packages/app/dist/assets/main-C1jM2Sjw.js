 ...
 */function v(n){return C({...n,state:!0,attribute:!1})}var ta=Object.defineProperty,Ni=(n,t,e,i)=>{for(var s=void 0,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=a(t,e,s)||s);return s&&ta(t,e,s),s};const ls=class ls extends q{constructor(){super(...arguments),this.display_name="Status: 401",this.curr_href=window.location.href,this._authObserver=new it(this,"acorn:auth"),this._historyObserver=new it(this,"acorn:history")}displayNameTemplate(){return this.display_name==="Status: 401"||this.display_name==="Status: 403"?p`
  ...
  `;let Bt=ls;Ni([C({attribute:!1})],Bt.prototype,"display_name");Ni([C()],Bt.prototype,"curr_href");function Zs(n){Gt.relay(n,"auth:message",["auth/signout"])}lt({"restful-form":We.FormElement});class ea extends q{render(){return p`
...
`+z)})})(this,0,$);break;case"color":L.style.fill=$||"";break;case"size":(function(D,F,w){var x=D._state;x.size&&(x.$iconHolder.style.width=x.$iconHolder.style.height="",x.size=x.sizeType=null),w&&!/^(xs|sm|md|lg)$/.test(x.size)&&(x.size=w.trim(),x.$iconHolder.style.width=x.$iconHolder.style.height=x.size)})(this,0,$);break;case"rotate":y&&L.classList.remove("bx-rotate-"+y),$&&L.classList.add("bx-rotate-"+$);break;case"flip":y&&L.classList.remove("bx-flip-"+y),$&&L.classList.add("bx-flip-"+$);break;case"animation":y&&L.classList.remove("bx-"+y),$&&L.classList.add("bx-"+$)}}},{key:"connectedCallback",value:function(){ct()&&k.ShadyCSS.styleElement(this)}}]),A}());s.default=Ot,Ot.define()}])},n.exports=e()})}(Te)),Te.exports}ia();const cs=class cs extends I{constructor(){super("acorn:model")}render(){return p`
    ...
    `}};ms.styles=[M,j,P`
        ...
        `];let ot=ms;we([v()],ot.prototype,"appointments",1);we([C({attribute:!1})],ot.prototype,"plan",2);we([v()],ot.prototype,"appointment_options",1);we([v()],ot.prototype,"appointment_additions",2);var $a=Object.defineProperty,xa=Object.getOwnPropertyDescriptor,rs=(n,t,e,i)=>{for(var s=i>1?void 0:i?xa(t,e):t,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=(i?a(t,e,s):a(s))||s);return i&&s&&$a(t,e,s),s};const me=class me extends I{get model_plan(){return this.model.plan}constructor(){super("acorn:model")}updated(t){super.updated(t);var e=this.model_plan;e&&(!this.plan||e.plan_id===this.plan.plan_id)&&(this.plan=e)}handleStaffRemove(t){const e=t.target,{name:i}=e;i!==void 0&&(this.dispatchMessage(["plans/staff/remove",{plan_id:this.plan.plan_id,user_id:parseInt(i)}]),this.requestPlanUpdate())}handleAppointmentRemove(t){const e=t.target,{name:i}=e;i!==void 0&&(this.dispatchMessage(["plans/appointment/remove",{plan_id:this.plan.plan_id,appointment_id:parseInt(i)}]),this.requestPlanUpdate())}requestPlanUpdate(){const t=new CustomEvent("plan-view:update",{bubbles:!0,composed:!0,detail:{}});this.dispatchEvent(t)}render(){if(!this.plan)return p`<section><p>Loading...</p></section>`;const t=i=>{var s,r;return p`
            <li>
                <span>${i.name}</span>
    ...
    `}};me.uses=lt({"add-staff-modal":at,"add-appointment-modal":ot}),me.styles=[M,j,P`
            section {
                background-color: var(--background-color-accent);
                border-radius: var(--border-size-radius);
                padding: var(--spacing-size-small) var(--spacing-size-medium);
    ...
    `}};ge.uses=lt({"plan-view":At,"available-modal":Et,"omissions-modal":V,"build-error-dialog":Jt,"info-dialog":ue,"unscheduled-modal":Pt}),ge.styles=[M,j,P`
        ...
        `];let U=ge;N([v()],U.prototype,"plans",1);N([v()],U.prototype,"services",1);N([v()],U.prototype,"build_error",1);N([v()],U.prototype,"showing_total",1);N([v()],U.prototype,"service_options",1);N([v()],U.prototype,"from_plan_date",2);N([v()],U.prototype,"per_page",2);N([v()],U.prototype,"page",2);N([v()],U.prototype,"filter_service_ids",2);N([v()],U.prototype,"routing_type",2);N([v()],U.prototype,"cleaning_window",2);N([v()],U.prototype,"max_hours",2);N([v()],U.prototype,"target_staff_count",2);N([v()],U.prototype,"duplicate_appointment_ids",1);var Ua=Object.defineProperty,Ma=Object.getOwnPropertyDescriptor,Ct=(n,t,e,i)=>{for(var s=i>1?void 0:i?Ma(t,e):t,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=(i?a(t,e,s):a(s))||s);return i&&s&&Ua(t,e,s),s};const Hi=P`
div.detail-header {
    padding-left: var(--spacing-size-small);
}
...
`,$s=class $s extends q{render(){return p`
    ...
    `];let fe=$s;Ct([C()],fe.prototype,"property",2);const ve=class ve extends q{render(){return p`
    <div class="page">
        <header>
            <h1>
                <slot name="property_name_header"><span>Property View</span></slot>
    ...
    `}};ve.uses=lt({"mu-form":rn.Element,"input-array":rr.Element}),ve.styles=[M,j,Hi,P`
        mu-form {
        grid-column: key / end;
        }
        mu-form input {
    ...
    `];let Vt=ve;Ct([C()],Vt.prototype,"property",2);Ct([C({attribute:!1})],Vt.prototype,"init",2);const be=class be extends I{constructor(){super("acorn:model"),this.edit=!1,this.properties_id=0}get property(){return this.model.property}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="properties-id"&&e!==i&&i&&(console.log("Property Page:",i),this.dispatchMessage(["properties/select",{properties_id:parseInt(i)}]))}render(){const{properties_id:t,property_name:e,address:i,status:s,estimated_cleaning_mins:r,double_unit:a=[]}=this.property||{properties_id:0},o=a.map(u=>p`
        <li>${u}</li>
        `),l=p`
    ...
    `];let zt=be;Ct([C({type:Boolean,reflect:!0})],zt.prototype,"edit",2);Ct([C({attribute:"properties-id",reflect:!0,type:Number})],zt.prototype,"properties_id",2);Ct([v()],zt.prototype,"property",1);const ja=[{path:"/app/appointments",view:()=>p`
