...
export type Msg =
  ...
  | ["appointments/", { from_service_date: string; to_service_date: string; per_page?: number; page?: number; filter_status_ids?: Array<number>; filter_service_ids?: Array<number>; show_unscheduled?: boolean; }]
  | ["appointments/select-unscheduled", { from_service_date: string; to_service_date: string; per_page?: number; page?: number; filter_status_ids?: Array<number>; filter_service_ids?: Array<number>; show_unscheduled?: boolean; }]
